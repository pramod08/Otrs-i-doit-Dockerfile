...
<table class="stepTable">
	...
	<tr>
		<td>&nbsp;</td>
		<td class="stepLineData">PHP <a target="_new" href="http://php.net/mysql">MySQL</a> Extension: [STEP1_WEBSERVER_PHP_MYSQL]</td>
		<td class="[STEP1_WEBSERVER_PHP_MYSQL_STATUS]">[STEP1_WEBSERVER_PHP_MYSQL_RESULT]</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td class="stepLineData">PHP <a target="_new" href="http://php.net/xml">XML</a> Extension: [STEP1_WEBSERVER_PHP_XML]</td>
		<td class="[STEP1_WEBSERVER_PHP_XML_STATUS]">[STEP1_WEBSERVER_PHP_XML_RESULT]</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td class="stepLineData">PHP <a target="_new" href="http://php.net/zlib">ZLIB</a> Extension: [STEP1_WEBSERVER_PHP_ZLIB]</td>
	...
	<tr>
		<td>&nbsp;</td>
		<td class="stepLineData">PHP <a target="_new" href="http://php.net/simplexml">SimpleXML</a> Extension: [STEP1_WEBSERVER_PHP_SIMPLEXML]</td>
	...
	<tr>
		<td>&nbsp;</td>
		<td class="stepLineData">PHP <a target="_new" href="http://php.net/curl">cURL</a> Extension: [STEP1_WEBSERVER_PHP_CURL]</td>
		<td class="[STEP1_WEBSERVER_PHP_CURL_STATUS]">[STEP1_WEBSERVER_PHP_CURL_RESULT]</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td class="stepLineData">PHP <a target="_new" href="http://php.net/curl">PDO_MySQL</a> Extension: [STEP1_WEBSERVER_PHP_PDO_MYSQL]</td>
		<td class="[STEP1_WEBSERVER_PHP_PDO_MYSQL_STATUS]">[STEP1_WEBSERVER_PHP_PDO_MYSQL_RESULT]</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td class="stepLineData">PHP <a target="_new" href="http://php.net/mcrypt">Mcrypt</a> Extension: [STEP1_WEBSERVER_PHP_MCRYPT]</td>
