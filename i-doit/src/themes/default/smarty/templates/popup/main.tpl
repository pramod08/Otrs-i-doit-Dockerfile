[{isys_group name="tom"}]<?xml version="1.0" ?>
...
<head>
	...
	<script type="text/javascript" language="JavaScript" src="[{$dir_tools}]js/scripts.js"></script>
	<script type="text/javascript" language="JavaScript" src="[{$dir_tools}]js/prototip/prototip.js"></script>
</head>
<!--Header end -->
