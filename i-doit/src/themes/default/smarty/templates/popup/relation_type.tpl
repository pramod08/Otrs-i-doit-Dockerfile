<div id="popup-relation-type">
	...
	<div class="popup-content">
		<table class="contentTable">
			<tr>
				<td class="key">[{isys type="f_label" ident="LC__CATG__RELATION__RELATION_TYPE" name="relation_type__title"}]<strong class="red">*</strong></td>
			...
			<tr>
				<td class="key vat">[{isys type="f_label" ident="LC__CATG__RELATION__RELATION_DESC_MASTER" name="relation_type__master"}]<strong class="red">*</strong></td>
				<td class="value">
			...
			<tr>
				<td class="key vat">[{isys type="f_label" ident="LC__CATG__RELATION__RELATION_DESC_SLAVE" name="relation_type__slave"}]<strong class="red">*</strong></td>
				<td class="value">
		...
		<p class="exception p5 m5" id="popup-relation-type-error" style="display:none;"></p>
	</div>
