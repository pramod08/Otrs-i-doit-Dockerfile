...
<head>
	...
	<link rel="stylesheet" type="text/css" media="print" href="./src/themes/default/print/print.css" />
...
<body>
	<div class="p10">
		...
		<div class="m10">
			...
			<a href="javascript:void(0);" onClick="var w = window.open('bugreport.php?url=[{$url}]&referrer=[{$ref}]', 'bugReport', 'width=800, height=600, left=30, top=30, dependant=yes, toolbar=no, location=no, status=no, menubar=no'); w.focus();">Report a bug</a> (E-Mail must be enabled in config.inc.php)
		</div>
	</div>
</body>
</html>