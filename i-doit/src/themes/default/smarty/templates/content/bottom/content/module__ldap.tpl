...
[{else}]
	...
	<fieldset class="overview">
		...
		<table class="contentTable">
			...
			<tr>
				<td class="key">Directory<span class="red">*</span></td>
			...
			<tr>
				<td class="key">[{isys type="lang" ident="IP / Hostname"}]<span class="red">*</span></td>
				<td class="value">[{isys type="f_text" name="C__MODULE__LDAP__HOST"}]</td>
			</tr>
			<tr>
				<td class="key">[{isys type="lang" ident="Port"}]<span class="red">*</span></td>
				<td class="value">[{isys type="f_text" name="C__MODULE__LDAP__PORT"}] <img src="[{$dir_images}]icons/silk/information.png" class="vam ml10" /> <em class="grey">default: 389</em></td>
			</tr>
			<tr>
				<td class="key">TLS</td>
			...
			<tr>
				<td class="key">Admin [{isys type="lang" ident="LC__LOGIN__USERNAME"}] (DN)<span class="red">*</span></td>
				<td class="value">[{isys type="f_text" name="C__MODULE__LDAP__DN"}]</td>
			</tr>
			<tr>
				<td class="key">[{isys type="lang" ident="LC__LOGIN__PASSWORD"}]<span class="red">*</span></td>
				<td class="value">[{isys type="f_text" p_bPassword="true" name="C__MODULE__LDAP__PASS"}]</td>
			</tr>
			<tr>
				<td class="key">Timelimit</td>
				<td class="value">[{isys type="f_text" name="C__MODULE__LDAP__TIMELIMIT"}] <img src="[{$dir_images}]icons/silk/information.png" class="vam ml10" /> <em class="grey">default: 30</em></td>
			</tr>
		</table>
	</fieldset>
	...
	<fieldset class="overview">
		...
		<table class="contentTable">
			...
			<tr>
				<td class="key">[{isys type="lang" ident="LC__LDAP__SEARCH_FOR_USERS_IN"}]<span class="red">*</span></td>
				<td class="value">
	...
	<fieldset id="openldap_only" class="overview" style="display:none;">
		...
		<table class="contentTable">
			<tr>
				<td class="key">[{isys type="lang" ident="LC__LDAP__SEARCH_FOR_GROUPS_IN"}]<span class="red">*</span></td>
				<td class="value">
	...
	<script type="text/javascript">
		...
		if ($connection_test) {
			$connection_test.on('click', function () {
				...
				new Ajax.Submit('index.php?moduleID=[{$smarty.get.moduleSubID}]&id=[{$smarty.get.id}]&connection_test=1&debug=' + $('debugLevel').value,
					'ajax_return',
					'isys_form',
					{
						onComplete: function () {
		...
		window.add_filter = function(p_title, p_value, p_type, p_link_type, p_operator) {
			var counter = $F('counter'),
				custom_title = new Element('input', {type:'text', name:'field_title[' + counter + ']', placeholder:'[{isys type="lang" ident="LC__LDAP__FILTER__ATTRIBUTE"}]', className:'ml5 mr15 inputText small', value:p_title}),
				custom_value = new Element('input', {type:'text', name:'field_value[' + counter + ']', placeholder:'[{isys type="lang" ident="LC__LDAP__FILTER__VALUE"}]', className:'ml5 mr15 inputText small', value:(p_value !== undefined)? p_value: ''}),
				custom_select = new Element('select', {name:'field_link_type[' + counter + ']', className:'inputDialog small'}),
				custom_select2 = new Element('select', {name:'field_operator[' + counter + ']', className:'inputDialog verysmall'});
		...
		[{if $isEditMode && count($filter_arr) > 0}]
