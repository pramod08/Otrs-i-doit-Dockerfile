...
<table class="contentTable">
	...
	<tr>
		...
		<td class="value">
			...
			[{isys type="f_dialog" name="C__CATG__NAGIOS_HOST_TPL_DEF_CHECK_PERIOD"}]<br />
	...
	<tr>
		...
		<td class="value">
			...
			[{isys type="f_dialog" name="C__CATG__NAGIOS_HOST_TPL_DEF_NOTIFICATION_PERIOD"}]<br />
...
<table class="contentTable" id="advanced_nagios_options">
	...
	<tr>
	    ...
	    <td class="value">[{isys type="f_dialog_list" name="C__CATG__NAGIOS_HOST_TPL_DEF_NOTIFICATION_OPTIONS" p_bDialogMode=true}]</td>
	</tr>
	<tr>
		...
		<td class="value pl20">
			...
			<img class="vam mouse-help" data-input-el="C__CATG__NAGIOS_HOST_TPL_DEF_CHECK_COMMAND" src="[{$dir_images}]icons/silk/information.png" /><br />
	...
	<tr>
		...
		<td class="value">[{isys type="f_dialog_list" name="C__CATG__NAGIOS_HOST_TPL_DEF_FLAP_DETECTION_OPTIONS" p_bDialogMode=true}]</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="value pl20">
			...
			<img class="vam mouse-help" data-input-el="C__CATG__NAGIOS_HOST_TPL_DEF_EVENT_HANDLER" src="[{$dir_images}]icons/silk/information.png" /><br />
	...
	<tr>
	    ...
	    <td class="value">[{isys type="f_dialog_list" name="C__CATG__NAGIOS_HOST_TPL_DEF_STALKING_OPTIONS" p_bDialogMode=true}]</td>
	</tr>
	<tr>
	    <td class="key">[{isys type='f_label' name='C__CATG__NAGIOS_HOST_TPL_DEF_ESCALATIONS__available_box' ident='escalations'}]</td>
	    <td class="value">[{isys type="f_dialog_list" name="C__CATG__NAGIOS_HOST_TPL_DEF_ESCALATIONS" p_bDialogMode=true}]</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="value">
			[{if isys_glob_is_edit_mode()}]
				<label><input type="radio" name="C__CATG__NAGIOS_HOST_TPL_DEF_DISPLAY_NAME_SELECTION" value="[{$smarty.const.C__CATG_NAGIOS__NAME_SELECTION__OBJ_ID}]" style="margin-left: 20px;" [{if $display_name_selection == $smarty.const.C__CATG_NAGIOS__NAME_SELECTION__OBJ_ID}]checked="checked"[{/if}] /> [{isys type="lang" ident="LC__UNIVERSAL__OBJECT_TITLE"}]</label><br />
				[{*<label><input type="radio" name="C__CATG__NAGIOS_HOST_TPL_DEF_DISPLAY_NAME_SELECTION" value="[{$smarty.const.C__CATG_NAGIOS__NAME_SELECTION__HOSTNAME}]" style="margin-left: 20px;" [{if $display_name_selection == $smarty.const.C__CATG_NAGIOS__NAME_SELECTION__HOSTNAME}]checked="checked"[{/if}] /> [{isys type="lang" ident="LC__CATP__IP__HOSTNAME"}]</label><br />*}]
				<input type="radio" name="C__CATG__NAGIOS_HOST_TPL_DEF_DISPLAY_NAME_SELECTION" value="[{$smarty.const.C__CATG_NAGIOS__NAME_SELECTION__INPUT}]" style="margin-left: 20px;" [{if $display_name_selection == $smarty.const.C__CATG_NAGIOS__NAME_SELECTION__INPUT}]checked="checked"[{/if}] /> [{isys type="f_text" name="C__CATG__NAGIOS_HOST_TPL_DEF_DISPLAY_NAME"}]
			[{else}]
