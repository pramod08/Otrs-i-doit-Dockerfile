...
<script type="text/javascript">
  add_status = function() {
  	...
  	var row = '<tr class="success">'+
		'<td>-</td>'+
		'<td>-</td>'+
		'<td><input type="text" class="inputText normal" name="new_status_title[]" onchange="this.up().next().down().value = \'C__CMDB_STATUS__\' + this.value.toUpperCase();" /></td>'+
		'<td><input type="text" class="inputText normal" name="new_status_const[]" value="C__CMDB_STATUS__" /></td>'+
		'<td><input type="text" class="inputText small jscolor" value="FFFFFF" name="new_status_color[]" autocomplete="off" /></td>'+
		'<td class="">'+
...
<hr />
	...
	[{foreach $cmdb_status as $s}]
		<tr class="[{cycle values="line0,line1"}]">
			...
			<td><input type="text" class="inputText normal" name="status_title[[{$s.isys_cmdb_status__id}]]" value="[{$s.isys_cmdb_status__title}]" /></td>
			<td><input type="text" class="inputText normal" style="color:#777;" name="status_const[[{$s.isys_cmdb_status__id}]]" value="[{$s.isys_cmdb_status__const}]" /></td>
			<td><input type="text" class="inputText small jscolor" value="[{$s.isys_cmdb_status__color}]" name="status_color[[{$s.isys_cmdb_status__id}]]" autocomplete="off" /></td>
			<td>
