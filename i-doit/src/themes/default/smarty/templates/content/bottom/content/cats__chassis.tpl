	...
	<tr>
		...
		<td>
			[{if $editmode == 1}]
				...
				[{isys type="f_dialog" name="C__CMDB__CATS__CHASSIS__LOCAL_ASSIGNMENT" p_onChange="window.change_assignment('dialog');" p_strClass="input input-small ml20" p_bInfoIconSpacer=0}]
				[{isys type="f_popup" p_strPopupType="browser_object_ng" p_strClass="input-mini ml20" name="C__CMDB__CATS__CHASSIS__ASSIGNED_DEVICES" p_strPlaceholder="LC__CMDB__CATS__CHASSIS__ASSIGNED_DEVICES__PLACEHOLDER" callback_accept="window.change_assignment('object', 'attach');" callback_detach="window.change_assignment('object', 'detach');" p_bInfoIconSpacer=0}]
				[{else}]
				<div id="C__CMDB__CATS__CHASSIS__VIEW_FIELD" class="input input-small value ml20 fl" style="min-height:24px; height:auto;">
					[{$view_field_content}]
				</div>
