<table class="contentTable">
	...
	<tr>
		...
		<td class="value">
			[{isys type="f_dialog" id="C__CATG__CONNECTOR__SUFFIX_SCHEMA" name="C__CATG__CONNECTOR__SUFFIX_SCHEMA" p_bDbFieldNN="1"}]
			[{isys type="f_text" p_strStyle="display:none;" name="C__CATG__CONNECTOR__SUFFIX_SCHEMA_OWN" id="C__CATG__CONNECTOR__SUFFIX_SCHEMA_OWN"}]
		</td>
	</tr>
	[{/if}]
	...
	<tr>
		...
		<td class="value">
			[{isys type="f_popup" p_strTable="isys_connection_type" p_strPopupType="dialog_plus" name="C__CATG__CONNECTOR__CONNECTION_TYPE" p_bDbFieldNN="1"}]
			[{$connection_type}]
		</td>
	</tr>
	<tr>
