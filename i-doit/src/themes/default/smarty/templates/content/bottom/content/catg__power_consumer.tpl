  	...
  	<tr>
      	...
      	<td class="value">
      		[{isys
				...
				catFilter="C__CATG__NETWORK;C__CMDB__SUBCAT__NETWORK_PORT;C__CMDB__SUBCAT__NETWORK_INTERFACE_L;C__CATG__CABLING;C__CATG__CONNECTOR;C__CATG__UNIVERSAL_INTERFACE"}]
      	</td>
  	</tr>
	<tr>
