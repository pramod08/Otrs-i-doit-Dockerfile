<div class="p5">
	...
	<table class="contentTable m5" style="width:auto;">
		<tr>
			<td class="p10">
				<p>[{isys type="lang" ident="LC_UNIVERSAL__OBJECT"}] 1</p>
				[{isys type="f_popup" p_strPopupType="browser_object_ng" p_bDisableDetach="1" name="C__CATS__RELATION_DETAILS__MASTER" p_strClass="input normal" p_bInfoIconSpacer=0}]
			</td>
			<td class="p10">
				<p>&nbsp;</p>
				[{isys type="f_dialog" p_bDbFieldNN="1" p_bInfoIconSpacer="0" name="C__CATS__RELATION_DETAILS__DIRECTION" p_strClass="input normal"}]
			</td>
			<td class="p10">
				<p>[{isys type="lang"  ident="LC_UNIVERSAL__OBJECT"}] 2</p>
				[{isys type="f_popup" p_strPopupType="browser_object_ng" p_bDisableDetach="1" relationOnly=1 name="C__CATS__RELATION_DETAILS__SLAVE" p_strClass="input normal" p_bInfoIconSpacer=0}]
			</td>
		</tr>
	</table>
	[{/if}]
