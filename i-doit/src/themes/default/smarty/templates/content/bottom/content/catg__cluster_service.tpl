	...
	<tr>
		...
		<td class="value">
			[{isys
				...
				catFilter="C__CATS__APPLICATION;C__CATS__CLUSTER_SERVICE;C__CATS__DBMS;C__CATS__MIDDLEWARE;C__CATS__SERVICE"
				callback_accept="idoit.callbackManager.triggerCallback('clusterservice__cluster_service_selected');"
				callback_detach="new Effect.SlideUp('cluster_options', {duration:0.2});"}]
		</td>
	</tr>
</table>
