...
<table class="contentTable m0">
	...
	<tr class="IPv4 IP" [{if $net_type != $smarty.const.C__CATS_NET_TYPE__IPV4}]style="display:none"[{/if}]>
	...
	<tr class="IPv4 IP" [{if $net_type != $smarty.const.C__CATS_NET_TYPE__IPV4}]style="display:none"[{/if}]>
		...
		<td class="value">
			[{isys type="f_text" name="C__CATS__NET__ADDRESS_RANGE_FROM_V4" p_strClass="input input-mini" p_bReadonly="1"}]
			<span class="ml5 mr5">-</span>
			[{isys type="f_text" name="C__CATS__NET__ADDRESS_RANGE_TO_V4" p_strClass="input input-mini" p_bReadonly="1" p_bInfoIconSpacer="0"}]
		</td>
	</tr>
	...
	<tr class="IPv4 IP" [{if $net_type != $smarty.const.C__CATS_NET_TYPE__IPV4}]style="display:none"[{/if}]>
		...
		<td class="value">[{isys type="f_dialog" name="C__CATS__NET__DEF_GW_V4"}]</td>
	</tr>

	[{* IPv6 below this comment *}]

	<tr class="IPv6 IP" [{if $net_type != $smarty.const.C__CATS_NET_TYPE__IPV6}]style="display:none"[{/if}]>
		<td class="key">[{isys type="f_label" ident="LC__CMDB__CATS__NET__NET" name="C__CATS__NET__NET_V6"}]</td>
		<td class="value">
			[{isys type="f_text" name="C__CATS__NET__NET_V6"}]
			<span class="ml5 mr5">/</span>
			[{isys type="f_text" name="C__CATS__NET__NET_V6_CIDR" p_bInfoIconSpacer="0" p_nSize="3" p_strClass="input input-mini" p_nMaxLen="3"}]
		</td>
	</tr>
	<tr class="IPv6 IP" [{if $net_type != $smarty.const.C__CATS_NET_TYPE__IPV6}]style="display:none"[{/if}]>
		<td class="key">[{isys type="f_label" ident="LC__CMDB__CATS__NET__ADDRESS_RANGE" name="C__CATS__NET__ADDRESS_RANGE_FROM"}]</td>
		<td class="value">
			[{isys type="f_text" name="C__CATS__NET__ADDRESS_RANGE_FROM" p_bReadonly=1}]
			<span class="ml5 mr5">-</span>
			[{isys type="f_text" name="C__CATS__NET__ADDRESS_RANGE_TO" p_bInfoIconSpacer="0" p_bReadonly=1}]
		</td>
	</tr>
	...
	<tr>
		...
		<td class="value">[{isys type="f_text" name="C__CATS__NET__REVERSE_DNS" id="C__CATS__NET__REVERSE_DNS" p_strClass="inputText"}]</td>
	</tr>
	<tr class="IP">
	...
	<tr>
		...
		<td class="value">[{isys name="C__CATS__NET__LAYER2" type="f_popup" p_strPopupType="browser_object_ng"}]</td>
	</tr>
</table>
...
<script>
	(function () {
		...
		var setNetArea = function () {
			...
			$net_v4.removeClassName('error');
			$net_mask.removeClassName('error');
		...
		if ($net_type) {
			$net_type.on('change', function () {
				$$('.contentTable .IP').each(function(e){
					e.show();
				});

				switch ($net_type.getValue()) {
					case '[{$smarty.const.C__CATS_NET_TYPE__IPV6}]':
						$$('.contentTable .IPv4').invoke('hide');
						break;
					case '[{$smarty.const.C__CATS_NET_TYPE__IPV4}]':
						$$('.contentTable .IPv6').invoke('hide');
						break;
					default:
						$$('.contentTable .IP').invoke('hide');
				}
			});
				...
				new Ajax.Request('?call=net&m=check_net_collision&ajax=1',
					{
						...
						onSuccess: function (transport) {
							...
							$net_collision_check_result.removeClassName('note').removeClassName('error');
