		...
		<td>
			<table class="pl20">
				<tr>
					...
					<td>[{isys type="f_text" name="C__CATG__SLA__WEEK_DAY__MONDAY_TIME_FROM"}]</td>
					<td>[{isys type="f_text" name="C__CATG__SLA__WEEK_DAY__MONDAY_TIME_TO"}]</td>
				</tr>
				<tr>
					<td>[{isys type="checkbox" name="C__CATG__SLA__WEEK_DAY__TUESDAY"}]</td>
					<td>[{isys type="f_text" name="C__CATG__SLA__WEEK_DAY__TUESDAY_TIME_FROM"}]</td>
					<td>[{isys type="f_text" name="C__CATG__SLA__WEEK_DAY__TUESDAY_TIME_TO"}]</td>
				</tr>
				<tr>
					<td>[{isys type="checkbox" name="C__CATG__SLA__WEEK_DAY__WEDNESDAY"}]</td>
					<td>[{isys type="f_text" name="C__CATG__SLA__WEEK_DAY__WEDNESDAY_TIME_FROM"}]</td>
					<td>[{isys type="f_text" name="C__CATG__SLA__WEEK_DAY__WEDNESDAY_TIME_TO"}]</td>
				</tr>
				<tr>
					<td>[{isys type="checkbox" name="C__CATG__SLA__WEEK_DAY__THURSDAY"}]</td>
					<td>[{isys type="f_text" name="C__CATG__SLA__WEEK_DAY__THURSDAY_TIME_FROM"}]</td>
					<td>[{isys type="f_text" name="C__CATG__SLA__WEEK_DAY__THURSDAY_TIME_TO"}]</td>
				</tr>
				<tr>
					<td>[{isys type="checkbox" name="C__CATG__SLA__WEEK_DAY__FRIDAY"}]</td>
					<td>[{isys type="f_text" name="C__CATG__SLA__WEEK_DAY__FRIDAY_TIME_FROM"}]</td>
					<td>[{isys type="f_text" name="C__CATG__SLA__WEEK_DAY__FRIDAY_TIME_TO"}]</td>
				</tr>
				<tr>
					<td>[{isys type="checkbox" name="C__CATG__SLA__WEEK_DAY__SATURDAY"}]</td>
					<td>[{isys type="f_text" name="C__CATG__SLA__WEEK_DAY__SATURDAY_TIME_FROM" }]</td>
					<td>[{isys type="f_text" name="C__CATG__SLA__WEEK_DAY__SATURDAY_TIME_TO"}]</td>
				</tr>
				<tr>
					<td>[{isys type="checkbox" name="C__CATG__SLA__WEEK_DAY__SUNDAY"}]</td>
					<td>[{isys type="f_text" name="C__CATG__SLA__WEEK_DAY__SUNDAY_TIME_FROM"}]</td>
					<td>[{isys type="f_text" name="C__CATG__SLA__WEEK_DAY__SUNDAY_TIME_TO"}]</td>
				</tr>
			</table>
		</td>
	</tr>
	...
	(function () {
		...
		if ($service_level && $service_level_description) {
			$service_level.on('change', function () {
				$service_level_description.removeClassName('error')
				...
				new Ajax.Request('?ajax=1&call=sla&func=get-service-level-description', {
					...
					onComplete: function (response) {
						...
						if (json.success) {
							...
							$service_level_description.addClassName('error').update(json.message);
						}
					}
				});
			});
