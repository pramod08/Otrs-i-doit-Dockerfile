...
<table style="border-top: none; display:none;" id="vm_guest" class="contentTable">
	<tr>
		...
		<td class="value">
			...
			typeFilter="C__OBJTYPE__CLIENT;C__OBJTYPE__BLADE_SERVER;C__OBJTYPE__VIRTUAL_CLIENT;C__OBJTYPE__VIRTUAL_SERVER;C__OBJTYPE__CLUSTER;C__OBJTYPE__SERVER;C__OBJTYPE__VIRTUAL_HOST"}]
		</td>
	</tr>
