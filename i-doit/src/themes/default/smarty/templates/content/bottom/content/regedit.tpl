<table class="contentTable">
	<tr>
		...
		<td class="value"> 
			<!--input class="inputText" type="f_text" name="reg_key" value="[{$regdata.key}]" /-->
	...
	<tr>
		...
		<td class="value">
			<!--textarea cols="60" rows="5" class="inputTextarea" name="reg_val">[{$regdata.val}]</textarea-->
	...
	<tr>
		...
		<td class="value">
			<!--input class="inputCheckbox" type="checkbox" name="reg_editable" /-->
			[{isys type="f_dialog" name="reg_editable" p_arData=$editableData p_strSelectedID=$editableDataSelectedID}]
		</td>
	</tr>
	<tr>
		<td colspan="2">
