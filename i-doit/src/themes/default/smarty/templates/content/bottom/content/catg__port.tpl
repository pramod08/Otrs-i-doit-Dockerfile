<table class="contentTable">
	...
	<tr>
		...
		<td class="value">
            ...
            [{isys type="f_dialog" p_bInfoIconSpacer="0" p_bDbFieldNN="1" name="C__CATG__PORT__SPEED"}]
        </td>
	</tr>
	<tr><td colspan="2"><hr style="margin:5px 0;" /></td></tr>
	<tr>
	...
	<tr>
		...
		<td class="value">
			[{isys
                ...
                callback_detach="idoit.callbackManager.triggerCallback('catg_port__detached_port');"
...
<script type="text/javascript">
	(function () {
        ...
        idoit.callbackManager.registerCallback('catg_port__detached_port', function () {
            cableView.setValue('');
        });
	}());
</script>