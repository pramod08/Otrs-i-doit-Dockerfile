...
<div id="selection">
	...
	<table class="contentTable" style="border-top: none;">
		<tr>
			<td>
				<button id="button_network" class="ml5 bold btn" type="button" data-show-id="network" data-type-value="[{$smarty.const.C__VIRTUAL_DEVICE__NETWORK}]">
					<img src="[{$dir_images}]icons/network-workgroup.png" class="mr5"/><span>[{isys type="lang" ident="LC__CMDB__CATG__NETWORK"}]</span>
				</button>
				<button id="button_storage" class="ml5 bold btn" type="button" data-show-id="storage" data-type-value="[{$smarty.const.C__VIRTUAL_DEVICE__STORAGE}]">
					<img src="[{$dir_images}]icons/drive-removable-media.png" class="mr5"/><span>[{isys type="lang" ident="LC__CATG__STORAGE"}]</span>
				</button>
				<button id="button_interface" class="ml5 bold btn" type="button" data-show-id="interface" data-type-value="[{$smarty.const.C__VIRTUAL_DEVICE__INTERFACE}]">
					<img src="[{$dir_images}]icons/desktop-peripherals.png" class="mr5"/><span>[{isys type="lang" ident="LC__CMDB__CATG__UNIVERSAL_INTERFACE"}]</span>
				</button>
			</td>
		</tr>
	</table>
