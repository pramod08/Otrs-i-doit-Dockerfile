<div id="catg-stack-view" class="p5">
	[{if $is_stacked}]
		...
		[{/foreach}]
	[{else}]
		<p class="p5 info"><img src="[{$dir_images}]icons/silk/information.png" class="vam mr5" /><span>[{isys type="lang" ident="LC__CATG__STACK_MEMBERSHIP__NO_MEMBERSHIP"}]</span></p>
	[{/if}]
</div>
