<table class="contentTable">
	...
	<tr>
		<td class="key">[{isys type="f_label" name="C__CATG__ACCOUNTING_ACQUIRE__VIEW" ident="LC__CMDB__CATG__GLOBAL_AQUIRE"}]</td>
		<td class="value">[{isys type="f_popup" name="C__CATG__ACCOUNTING_ACQUIRE" p_strPopupType="calendar" p_bTime="0"}]</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="value">[{isys type="f_text" name="C__CATG__ACCOUNTING_GUARANTEE_PERIOD"}][{isys type="f_dialog" name="C__CATG__ACCOUNTING_GUARANTEE_PERIOD_UNIT"}]</td>
	</tr>
	<tr>
