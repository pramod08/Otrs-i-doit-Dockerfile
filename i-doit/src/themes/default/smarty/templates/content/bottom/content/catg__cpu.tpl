<table class="contentTable">
    ...
    <tr>
        ...
        <td class="value">[{isys type="f_count" p_bNeg="0" p_strStyle="width:30px;" name="C__CATG__CPU_NUMBER2CREATE"}]</td>
    </tr>
    <tr>
        <td colspan="2">
            <hr class="mt5 mb5" />
    ...
    <tr>
        ...
        <td class="value">[{isys type="f_count" p_bNeg="0" p_strClass="verysmall" name="C__CATG__CPU_CORES"}]</td>
    </tr>
    <tr>
