...
<table class="contentTable">
	...
	<tr>
		...
		<td class="value">
			...
			[{isys type="f_dialog" name="C__CATG__NAGIOS_SERVICE_DEF__CHECK_COMMAND" p_strClass="normal" p_bInfoIconSpacer=0 p_onChange="idoit.callbackManager.triggerCallback('nagios_service__check_command_description', this.id);"}]&nbsp;
			<img class="vam mouse-help" data-input-el="C__CATG__NAGIOS_SERVICE_DEF__CHECK_COMMAND" src="[{$dir_images}]icons/silk/information.png" /><br />

			<img src="[{$dir_images}]empty.gif" width="20" height="1" />
			[{if isys_glob_is_edit_mode()}]<input type="radio" name="C__CHECK_COMMAND_SELECTION" disabled="disabled" />[{/if}]
			[{isys type="f_popup" p_strPopupType="dialog_plus" name="C__CATG__NAGIOS_SERVICE_DEF__CHECK_COMMAND_PLUS" p_strTable="isys_nagios_commands_plus" p_strClass="normal mt5" p_bInfoIconSpacer=0}]
		</td>
	</tr>
	<tr>
...
<table class="contentTable" id="advanced_nagios_options">
	...
	<tr>
		...
		<td class="value">
			...
			[{isys type="f_dialog" name="C__CATG__NAGIOS_SERVICE_DEF__CHECK_PERIOD" p_strClass="normal" p_bInfoIconSpacer=0}]<br />

			<img src="[{$dir_images}]empty.gif" width="20" height="1" />
			[{if isys_glob_is_edit_mode()}]<input type="radio" name="C__CHECK_PERIOD_SELECTION" disabled="disabled" />[{/if}]
			[{isys type="f_popup" p_strPopupType="dialog_plus" name="C__CATG__NAGIOS_SERVICE_DEF__CHECK_PERIOD_PLUS" p_strTable="isys_nagios_timeperiods_plus" p_strClass="normal mt5" p_bInfoIconSpacer=0}]
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="value">
			...
			[{isys type="f_dialog" name="C__CATG__NAGIOS_SERVICE_DEF__NOTIFICATION_PERIOD"}]<br />
	...
	<tr>
		...
		<td class="value">[{isys type="f_dialog_list" name="C__CATG__NAGIOS_SERVICE_DEF__NOTIFICATION_OPTIONS" p_bDialogMode=true}]</td>
	</tr>
	...
	<tr>
		...
		<td class="value">[{isys type="f_dialog_list" name="C__CATG__NAGIOS_SERVICE_DEF__FLAP_DETECTION_OPTIONS" p_bDialogMode=true}]</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="value pl20">
			...
			[{isys type="f_dialog" name="C__CATG__NAGIOS_SERVICE_DEF__EVENT_HANDLER"}]&nbsp;<img class="vam mouse-help" data-input-el="C__CATG__NAGIOS_SERVICE_DEF__EVENT_HANDLER" src="[{$dir_images}]icons/silk/information.png" /><br />
	...
	<tr>
		...
		<td class="value">[{isys type="f_dialog_list" name="C__CATG__NAGIOS_SERVICE_DEF__ESCALATIONS" p_bDialogMode=true}]</td>
	</tr>
	<tr>
	...
	<tr>
		...
		[{if isys_glob_is_edit_mode()}]
			<input type="radio" name="C__CATG__NAGIOS_SERVICE_DEF__DISPLAY_NAME_SELECTION" value="[{$smarty.const.C__CATG_NAGIOS__NAME_SELECTION__INPUT}]" style="margin-left: 20px;" [{if $display_name_selection == $smarty.const.C__CATG_NAGIOS__NAME_SELECTION__INPUT}]checked="checked"[{/if}] /> [{isys type="f_text" name="C__CATG__NAGIOS_SERVICE_DEF__DISPLAY_NAME" p_strClass="normal" p_bInfoIconSpacer=0}]
			<br />
			<label>
			<input type="radio" name="C__CATG__NAGIOS_SERVICE_DEF__DISPLAY_NAME_SELECTION" value="[{$smarty.const.C__CATG_NAGIOS__NAME_SELECTION__OBJ_ID}]" style="margin-left: 20px;" [{if $display_name_selection == $smarty.const.C__CATG_NAGIOS__NAME_SELECTION__OBJ_ID}]checked="checked"[{/if}] />
