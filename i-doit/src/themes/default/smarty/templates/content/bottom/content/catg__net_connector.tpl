<table class="contentTable">
	...
	<tr>
		...
		<td class="value">
			[{isys type='f_dialog' placeholder="LC__CMDB__CATG__NET_CONNECTOR__CONNECTED_TO_PLACEHOLDER" name='C__CMDB__CATG__NET_CONNECTOR__CONNECTED_TO_LISTENER' p_strClass="normal"}]
		</td>
	</tr>
	<tr>
