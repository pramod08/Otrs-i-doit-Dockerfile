<tr style="display:none" class="suf">
	...
	<td class="value">
		...
		[{isys type="f_text" p_bInfoIconSpacer="0" p_bEditMode="1" name="object_appending_own" id="object_appending_own" p_strStyle="display:none;" p_strClass="normal" p_strValue="##COUNT##" p_onChange="show_preview();"}]
	</td>
</tr>
<tr style="display:none" class="suf">
	<td valign="top" class="strong"><label for="count_starting_at">[{isys type="lang" ident="LC__WORKFLOWS__STARTING_NOW"}]:</label></td>
	<td class="value">[{isys type="f_text" p_bInfoIconSpacer="1" p_bEditMode="1" p_strClass="small" p_onChange="show_preview();" name="count_starting_at" id="count_starting_at" p_strValue="0"}]</td>
</tr>
<tr style="display:none" class="suf">
	<td valign="top" class="strong"><label for="zero_point_calc">[{isys type="lang" ident="LC__UNIVERSAL__LEADING_ZEROS"}]:</label></td>
	<td class="value">
		[{isys type="f_text" p_bInfoIconSpacer="1" p_bEditMode="1" p_strClass="small" name="zero_points" id="zero_points" p_strValue="2" p_onChange="show_preview();"}]
		<label>
