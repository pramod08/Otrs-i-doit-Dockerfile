<table class="contentTable">
	...
	<tr>
		...
		<td class="value">
			[{isys title="LC__BROWSER__TITLE__NET" name="C__CATS__LAYER2__LAYER3_NET" type="f_popup" multiselection="true" p_strPopupType="browser_object_ng" typeFilter="C__OBJTYPE__LAYER3_NET"}]
		</td>
	</tr>
	<tr>
		<td colspan="2">
			...
			<table id="table_iphelper_addresses">
				...
				[{foreach from=$ip_helper_address key="index" item="iphelper"}]
					...
					<tr id="row_[{$index+1}]">
						...
						<td>
							[{isys type="f_popup" p_strPopupType="dialog_plus" p_strTable="isys_layer2_iphelper_type" name="ip_helper[$tmp_counter][type]" p_strClass="inputDialog ip_helper_types normal" p_strSelectedID=$iphelper.isys_cats_layer2_net_2_iphelper__isys_layer2_net_iphelper_type p_bInfoIconSpacer=0 callback_accept="idoit.callbackManager.triggerCallback('l2net_update_ip_helper');"}]
...
<div id="new_iphelper_template" class="hide">
    [{isys type="f_popup" p_strPopupType="dialog_plus" p_strTable="isys_layer2_iphelper_type" name="{type_name}" id="{type_id}" p_strClass="inputDialog ip_helper_types normal" p_bInfoIconSpacer=0 callback_accept="idoit.callbackManager.triggerCallback('l2net_update_ip_helper');"}] [{isys type="f_text" name="{ip_name}" id="{ip_id}" p_strClass="normal"}]
</div>
