<table class="contentTable">
	...
	<tr>
		...
		<td class="value">[{isys type="f_count" p_strStyle="width:30px;" name="C__CMDB__CATS__PDU__BRANCH_ID" tab="1"}] [{$branch_title}]</td>
	</tr>
	<tr>
		<td class="key">[{isys type="f_label" ident="Receptables" name="C__CMDB__CATS__PDU__RECEPTABLES"}]</td>
		<td class="value">[{isys type="f_count" p_strStyle="width:30px;" name="C__CMDB__CATS__PDU__RECEPTABLES" tab="2"}]</td>
	</tr>
</table>
