...
<div id="contentHeader" class="bottom-inset-shadow">
	...
	<div id="contentHeaderTable" class="m0 p5">
		...
		<h1 class="m0" style="padding-top:3px;" id="contentTopTitle">
			[{if $content_title != ""}]
		...
		<table id="contentHeaderInnerTable" class="border-none mt5" style="[{if $contentTop == "off"}]display:none;[{/if}]" cellpadding="2px" cellspacing="0px;">
			<tr>
				...
				<td class="bold">[{isys type="f_data" name="C__CATG__SYSID" p_bInfoIconSpacer="0"}]</td>
				<td class="border-left">[{isys type="lang" ident="LC__CMDB__CATG__LOCATION"}]</td>
				<td class="strip bold">[{isys type="f_data" name="C__CATG__LOCATION" p_bInfoIconSpacer="0"}]</td>
			</tr>
			<tr>
				<td>[{isys type="lang" ident="LC__CMDB__CATG__PURPOSE"}]</td>
				<td class="bold">[{isys type="f_data" name="C__CATG__PURPOSE" p_bInfoIconSpacer="0"}]</td>
				<td class="border-left">[{isys type="lang" ident="LC__CMDB__CATG__CONTACT"}]</td>
				<td class="bold">[{isys type="f_data" name="C__CATG__CONTACT" p_bInfoIconSpacer="0"}]</td>
			</tr>
			<tr>
				<td>[{isys type="lang" ident="LC__CMDB__CATG__RELATION"}]</td>
				<td class="bold">[{isys type="f_data" name="C__CATG__RELATIONS" p_bInfoIconSpacer="0"}]</td>
				<td class="border-left">[{isys type="lang" ident="LC__OBJECTDETAIL__ACCESS"}]</td>
				<td class="strip bold">[{isys type="f_data" name="C__CATG__ACCESS" p_bInfoIconSpacer="0"}]</td>
			</tr>
		</table>
