...
<table class="listing" cellpadding="0" cellspacing="0" border="0" style="width:100%;">
	<tr>
		<td colspan="2" class="p5">
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					<td>
						<button type="button" class="btn btn-small btn-block bold" onClick="mydoit_addBookmark();">
							<img src="[{$dir_images}]icons/silk/page_add.png" class="mr5" />
							<span>[{isys type="lang" ident="LC__UNIVERSAL__BUTTON_ADD"}]</span>
						</button>
					</td>
					<td class="pl5">
						<button type="button" class="btn btn-small btn-block bold" onClick="mydoit_deleteBookmark();">
