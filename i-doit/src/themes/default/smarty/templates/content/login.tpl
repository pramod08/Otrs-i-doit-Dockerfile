					...
					<table cellpadding="2" cellspacing="0" id="loginTable" align="right">
						<tr>
							...
							<td>
								...
								<input class="inputTextLogin" value="" type="input" [{$username_disable}] name="login_username" id="login_username" value="[{$login_username}]" onkeypress="if(event.keyCode==13||event.keyCode==3) { load_mandants('isys_form', 'login_submit'); return false; }" />
							</td>
						</tr>
						<tr>
							<td>[{isys type="lang" ident="Password"}]: </td>
							<td><input class="inputTextLogin" value="" type="password" [{$password_disable}]  name="login_password" id="login_password" onkeypress="if(event.keyCode==13||event.keyCode==3) { load_mandants('isys_form', 'login_submit'); return false; }" /></td>
						</tr>
						<tr>
							<td colspan="2">
								<div id="login_submit">
