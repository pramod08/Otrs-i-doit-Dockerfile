...
<table id="nagios-config" class="contentTable">
	...
	<tr>
		...
		<td class="value">
			...
			<button type="button" id="new_resource_file" class="btn btn-small">[{isys type="lang" ident="LC__UNIVERSAL__BUTTON_ADD"}] <img src="[{$dir_images}]icons/silk/add.png" alt="+" title="[{isys type="lang" ident="LC__UNIVERSAL__BUTTON_ADD"}]" /></button>
			[{/if}]
    ...
    <tr>
        ...
        <td class="value">
            ...
            <button type="button" id="new_broker" class="btn btn-small">[{isys type="lang" ident="LC__UNIVERSAL__BUTTON_ADD"}] <img src="[{$dir_images}]icons/silk/add.png" alt="+" title="[{isys type="lang" ident="LC__UNIVERSAL__BUTTON_ADD"}]" /></button>
	        [{/if}]
	...
	<tr>
		...
		<td class="value">
			...
			<button type="button" id="new_cfg_file" class="btn btn-small">[{isys type="lang" ident="LC__UNIVERSAL__BUTTON_ADD"}] <img src="[{$dir_images}]icons/silk/add.png" alt="+" title="[{isys type="lang" ident="LC__UNIVERSAL__BUTTON_ADD"}]" /></button>
			[{/if}]
	...
	<tr>
		...
		<td class="value">
			...
			<button type="button" id="new_cfg_dir" class="btn btn-small">[{isys type="lang" ident="LC__UNIVERSAL__BUTTON_ADD"}] <img src="[{$dir_images}]icons/silk/add.png" alt="+" title="[{isys type="lang" ident="LC__UNIVERSAL__BUTTON_ADD"}]" /></button>
			[{/if}]
