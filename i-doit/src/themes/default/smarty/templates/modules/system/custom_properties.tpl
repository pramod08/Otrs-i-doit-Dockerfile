...
<div class="m5 info p5">
	[{isys type="lang" ident="LC__CUSTOM_PROPERTIES__HELP" values=array($i)}]
</div>
			...
			<table class="contentTable">
				...
				[{foreach from=$item.data item=custom_property_data key=custom_field_name}]
					...
					<tr>
						...
						<td class="value">
							[{isys type="f_text" name="data[$key][$custom_field_name]" p_strPlaceholder="LC__CUSTOM_PROPERTIES__NAME" p_strValue=$custom_property_data.info.title}]
						</td>
						<td>
