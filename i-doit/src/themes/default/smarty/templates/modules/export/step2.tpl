...
<fieldset class="overview">
	...
	<div class="pt20 p10">
		...
		[{isys name="object_ids" type="f_popup" edit_mode=1 p_bInfoIconSpacer=0 p_strPopupType="browser_object_ng" multiselection=true}]
	</div>
	...
	<div class="pt20 p10">
		[{isys name="C__CATG__LOCATION_PARENT" id="C__CATG__LOCATION_PARENT" type="f_popup" p_strPopupType="browser_location" p_strStyle="width:600px;" edit=1 p_bInfoIconSpacer=0 containers_only=true}]
	</div>
...
<fieldset class="overview">
	...
	<div class="pt20 p10">
	    <label>
		    ...
		    [{isys type="f_dialog" name="type" p_arData=$export_types onchange="show_categories(this);" p_strClass="input-mini" p_bDbFieldNN=1 p_bEditMode=1}]
	    </label>
	</div>
</fieldset>
