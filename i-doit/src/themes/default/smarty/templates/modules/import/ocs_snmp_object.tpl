<fieldset class="overview">
    ...
    <table class="contentTable">
        ...
        <tr>
            <td class="key">
                [{isys type="f_label" name="ocs_overwrite_hostaddress_port" ident="LC__MODULE__OCS_IMPORT__OVERWRITE_HOSTADDRESS_AND_PORTS"}]
            </td>
            <td class="value pl10">
                [{html_options name="ocs_overwrite_hostaddress_port" id="ocs_overwrite_hostaddress_port" options=$yes_no_selection selected=0}]
            </td>
        </tr>
    </table>
</fieldset>
