...
<div>
	<div class="p10">
        <div id="ocs_error" style="display:none;">
            <h3>[{isys type="lang" ident="LC__OCS__DB_ERROR"}]</h3>
            <p class="m5"><a target="_blank" href="?moduleID=[{$smarty.const.C__MODULE__SYSTEM}]&what=ocsdb&[{$smarty.const.C__GET__MODULE_SUB_ID}]=[{$smarty.const.C__MODULE__IMPORT}]&[{$smarty.const.C__GET__TREE_NODE}]=[{$smarty.const.C__MODULE__IMPORT}]7">[{isys type="lang" ident="LC__MODULE__IMPORT__OCS__TO_OCS_DATABASE_CONFIGURATION"}]</a></p>
        </div>
        <table class="contentTable" id="ocs_db_list">
            ...
            <tr>
                ...
                <td class="value pl20">
					<select name="" id="ocs_overwrite_hostaddress_port_multi">
			...
			<tr>
				...
				<td class="value pl20">
					<select name="" id="ocs_logging_multi">
	...
	<div class="m5" id="ocs_list_import_button">
		...
		<p class="error red p5 mt10" id="ocs_no_selection_error" style="display:none;">
