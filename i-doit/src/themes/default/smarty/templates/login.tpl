...
<div id="loginArea">
	<div id="loginMessages">
		<div class="login_error exception" id="login_error" [{if empty($login_error)}]style="display:none;"[{/if}]>
			<div class="p5">
		...
		<div id="loginContent">
			...
			<table id="" cellpadding="0" cellspacing="0" border="0"
				...
				<tr>
					...
					<td align="right">
						<p class="login_msg">
							<a href="./admin/">Admin-Center</a> - <a class="bold" href="http://www.i-doit.com" target="_blank">i-doit.com</a> - &copy; synetics gmbh
						</p>
					</td>
				</tr>
			</table>
