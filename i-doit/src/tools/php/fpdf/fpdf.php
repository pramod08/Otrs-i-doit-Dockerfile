...
//Private properties
        ...
        function FPDF($orientation = 'P', $unit = 'mm', $format = 'A4')
        {
            ...
            if (is_string($format))
            {
                ...
                elseif ($format == 'a4') $format = [
                    595.28,
                    841.89
                ];
                elseif ($format == 'a5') $format = [
                    420.94,
                    595.28
                ];
                elseif ($format == 'letter') $format = [
                    612,
                    792
                ];
                elseif ($format == 'legal') $format = [
                    612,
                    1008
                ];
                else
        ...
        function Cell($w, $h = 0, $txt = '', $border = 0, $ln = 0, $align = '', $fill = 0, $link = '')
        {
            ...
            if (is_string($border))
            {
                ...
                if (strpos($border, 'R') !== false) $s .= sprintf(
                    '%.2f %.2f m %.2f %.2f l S ',
                    ($x + $w) * $k,
                    ($this->h - $y) * $k,
                    ($x + $w) * $k,
                ...
                if (strpos($border, 'B') !== false) $s .= sprintf(
                    '%.2f %.2f m %.2f %.2f l S ',
                    $x * $k,
                    ($this->h - ($y + $h)) * $k,
                    ($x + $w) * $k,
