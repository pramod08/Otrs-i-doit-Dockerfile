...
/* Extend prototype browser detection */
if (!('IE8' in Prototype.Browser)) {
  Prototype.Browser.IEVersion = (navigator.appVersion.split(';').length > 1) ? parseFloat(navigator.appVersion.split(';')[1].strip().split(' ')[1]) : 0;
