...
$g_ldapconf = [
     ...
     * Example:
     *  "rooms" => array(
     *   	"RZ01" => array("admin", "editor", "author),
     *   	"RZ02" => array("admin")
     *  )
     *
     */
     ...
     *
     * Examples:
     *  'ignoreUsersWithAttributes' => array('samaccountname', 'sn'), // Ignore users with empty loginname and lastname
     *  'ignoreUsersWithAttributes' => array('givenName', 'sn'),      // Ignore all users who have an empty first- and lastname
     *
     * Default (don't ignore anything):
     *  'ignoreUsersWithAttributes' => array()
     */
