...
class isys_cmdb_ui_category_g_jdisc_discovery extends isys_cmdb_ui_category_global
{
    public function process(isys_cmdb_dao_category $p_cat)
    {
        ...
        $l_primary_hostname      = $l_dao_ip->dynamic_property_callback_primary_hostname(['isys_obj__id' => $_GET[C__CMDB__GET__OBJECT]]);
        ...
        $l_rules['C__CMDB__CATG__JDISC_DISCOVERY__MODE']['p_arData']        = serialize(
            [
        ...
        $l_rules['C__CMDB__CATG__JDISC_DISCOVERY__IP_CONFLICTS']['p_arData']        = serialize(get_smarty_arr_YES_NO());
        $l_rules['C__CMDB__CATG__JDISC_DISCOVERY__IP_CONFLICTS']['p_strSelectedID'] = 0;

        $l_template->assign('object_id', $_GET[C__CMDB__GET__OBJECT])
            ->assign('objectTypeID', $_GET[C__CMDB__GET__OBJECTTYPE])
            ->assign('is_jedi', $l_module->is_jedi())
            ->assign('primary_ip', $l_primary_address)
            ->assign('primary_hostname', $l_primary_hostname)
    ...
    public function __construct(isys_component_template &$p_template)
    {
        ...
        $this->set_template(
            $g_dirs["class"] . DS . "modules" . DS . "jdisc" . DS . "templates" . DS . "content" . DS . "bottom" . DS . "content" . DS . "catg__jdisc_discoverys.tpl"
        );
    }
} // class
?>