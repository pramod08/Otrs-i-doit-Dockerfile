<div>
    <table class="contentTable">
        <tr>
            ...
            <td class="value">
                [{isys type='f_dialog' p_bDbFieldNN=1 name='C__CMDB__CATG__JDISC_DISCOVERY__SERVER' p_strClass="normal" tab='2' p_bEditMode=1}]
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="value">
                [{isys type='f_dialog' name='C__CMDB__CATG__JDISC_DISCOVERY__PROFILE' p_strClass="normal" tab='2' p_bEditMode=1}]
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="value">
                [{isys type="f_dialog" name="C__CMDB__CATG__JDISC_DISCOVERY__IP_CONFLICTS" p_bEditMode=1 p_strClass="normal" p_bDisabled=$ip_unique_check p_bDbFieldNN=true p_strInfoIconWarning=$ip_overwrite_warning p_strInfoIconHelp=$ip_overwrite_info}]
            </td>
        </tr>
        [{/if}]
        ...
        <tr>
            ...
            <td>
                [{isys type="f_dialog" name="C__CMDB__CATG__JDISC_DISCOVERY__MODE" p_strClass="normal" p_bEditMode=1 p_bDbFieldNN=true}]
            </td>
        </tr>
    ...
    (function () {
        ...
        if($('C__CMDB__CATG__JDISC_DISCOVERY__SERVER')) {
            ...
            $('C__CMDB__CATG__JDISC_DISCOVERY__SERVER').on('change', function (ele) {
                ...
                {
                    $('module-jdisc-import-message').addClassName('error');
                    $('module-jdisc-import-message').removeClassName('hide');
                    $('module-jdisc-import-message').update('No primary IP defined.')
                }
            });
            ...
            var start_jdisc_import = function() {
                ...
                var message_container = $('module-jdisc-import-message').update().removeClassName('error').removeClassName('note'),
                ...
                new Ajax.Request('?call=jdisc&ajax=1&func=import',
                {
                    parameters: {
                        ...
                        'filter_type': 'filter_hostaddress',
                        'filter_data': '|'+$('C__MODULE__JDISC__IMPORT__FILTER__ADDRESS').value+'|',
            ...
            var start_jdisc_scan = function() {
                ...
                req = new Ajax.Request(req_url,
                {
                    ...
                    onSuccess: function (transport) {
                        // IE 9 solution because oninteractive does not work
                        if(req_params[3] == false)
                        {
                            $('jdisc-discovery-scan-container-loader').addClassName('hide');
                            ...
                            var $lines = req_params[1].split('\n');
                            var $lines_last_index = parseInt($lines['length']) - 1;
                            var $json = JSON.parse($lines[($lines_last_index)]);

                            if($json.success)
                            {
                                $lines.each(function($element, $index){
                                    if($index < $lines_last_index)
                                    {
                                        //req_params[0].innerHTML += $element + "<br />";
                                        req_params[0].insert($element + "<br />");
                                    }
                                });
