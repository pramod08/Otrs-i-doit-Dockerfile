    ...
    <div id="import">
        ...
        <table class="contentTable" style="border-top: none;">
            <tr>
                ...
                <td class="value">
                    [{isys type="f_dialog" name="C__MODULE__JDISC__IMPORT__JDISC_SERVERS" p_strClass="normal" p_bDbFieldNN=1 p_bSort=false}]
            ...
            <tr>
                ...
                <td>
                    ...
                    <dl class="ml20 mt10">
                        <dt class="bold">[{isys type='lang' ident='LC__MODULE__JDISC__IMPORT__MODE'}]:</dt>
            ...
            <tr>
                ...
                <td class="value">
                    [{isys type="f_dialog" name="C__MODULE__JDISC__IMPORT__IP_CONFLICTS" p_strClass="normal" p_bDisabled=$ip_unique_check p_bDbFieldNN=true p_strInfoIconWarning=$ip_overwrite_warning p_strInfoIconHelp=$ip_overwrite_info}]
                </td>
            </tr>
            [{/if}]
            <tr>
                ...
                <td class="value pl20">
                    <select name="" id="module-jdisc-import-detailed-logging">
            ...
            $('C__MODULE__JDISC__IMPORT__BUTTON').on('click', function () {
                ...
                new Ajax.Request('?call=jdisc&ajax=1&func=import',
                {
                    ...
                    onComplete: function (transport) {
                        ...
                        [{if isset($dirs.temp)}]
                            error_msg = '[{isys type="lang" ident="LC__MODULE__JDISC__IMPORT__REQUEST_ERROR" values=addslashes($dirs.temp)}]';
                        [{else}]
                        ...
                        if (typeof transport.responseJSON == 'undefined')
                        {
                            ...
                            log_container.update(error_msg + '<br />' + transport.responseText).addClassName('error mt15 m10');
                        }
                        else
                        {
	                        if (json) {
