...
<div id="jdisc-module-config">
	...
	<table class="contentTable" style="border-top: none;">
        <tr>
            ...
            <td class="value">
                [{isys type="f_dialog" name="C__MODULE__JDISC__IMPORT__JDISC_SERVERS" p_strClass="normal" p_bSort=false p_onChange="window.reload_profile(this.value);"}]
		...
		<tr>
			...
			<td class="value">[{isys type='f_text' name='C__MODULE__JDISC__PROFILES__TITLE' p_strClass="large"}]</td>
		</tr>
		<tr>
			...
			<td class="value">[{isys type='f_textarea' name='C__MODULE__JDISC__PROFILES__DESCRIPTION' p_strClass="large"}]</td>
		</tr>
	</table>
	...
	<table class="contentTable" style="border-top: none;">
		...
		<tr>
			...
			<td class="value" style="vertical-align: middle">
				<input type="checkbox" id="C__MODULE__JDISC__ONLY_CREATE_SOFTWARE_RELATIONS" name="C__MODULE__JDISC__ONLY_CREATE_SOFTWARE_RELATIONS" [{if $import_all_software}]checked="checked"[{/if}] style="margin-left:15px;" />
			</td>
		</tr>
		<tr>
			...
			<td class="value" style="vertical-align: middle">
				<input type="checkbox" id="C__MODULE__JDISC__ONLY_CREATE_NETWORK_RELATIONS" name="C__MODULE__JDISC__ONLY_CREATE_NETWORK_RELATIONS" [{if $import_all_networks}]checked="checked"[{/if}] style="margin-left:15px;" />
			</td>
		</tr>
        <tr>
            ...
            <td class="value" style="vertical-align: middle">
                <input type="checkbox" id="C__MODULE__JDISC__CREATE_VLAN_RELATIONS" name="C__MODULE__JDISC__CREATE_VLAN_RELATIONS" [{if $import_all_vlans}]checked="checked"[{/if}] style="margin-left:15px;" />
            </td>
        </tr>
        <tr>
            ...
            <td class="value" style="vertical-align: middle">
                <input type="checkbox" id="C__MODULE__JDISC__CREATE_CLUSTER" name="C__MODULE__JDISC__CREATE_CLUSTER" [{if $import_all_clusters}]checked="checked"[{/if}] style="margin-left:15px;" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="value" style="vertical-align: middle">
                <input type="checkbox" id="C__MODULE__JDISC__CREATE_BLADE_CONNECTIONS" name="C__MODULE__JDISC__CREATE_BLADE_CONNECTIONS" [{if $import_all_blade_connections}]checked="checked"[{/if}] style="margin-left:15px;" />
        ...
        <tr>
            ...
            <td class="value" style="vertical-align: middle">
                <input type="checkbox" id="C__MODULE__JDISC__IMPORT_CUSTOM_ATTRIBUTES" name="C__MODULE__JDISC__IMPORT_CUSTOM_ATTRIBUTES" [{if $import_custom_attributes}]checked="checked"[{/if}] style="margin-left:15px;" />
            </td>
        </tr>
        [{/if}]
        ...
        <tr>
            ...
            <td class="value" style="vertical-align: middle">
                <input type="checkbox" id="C__MODULE__JDISC__USE_DEFAULT_TEMPLATES" name="C__MODULE__JDISC__USE_DEFAULT_TEMPLATES" [{if $use_default_templates}]checked="checked"[{/if}] style="margin-left:15px;" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="value" style="vertical-align: middle">
                ...
                <br />
                [{isys type="f_textarea" name="C__MODULE__JDISC__SOFTWARE_FILTER" p_bDbFieldNN=1}]
            </td>
        </tr>
