 ...
 */
define("C__PAGE__LOGBOOK_VIEW", 1);
define("C__PAGE__LOGBOOK_ARCHIVE", 2);
define("C__PAGE__LOGBOOK_RESTORE", 3);
define("C__PAGE__LOGBOOK_CONFIGURATION", 4);
...
class isys_module_logbook extends isys_module implements isys_module_interface, isys_module_authable
{
    ...
    public function build_tree(isys_component_tree $p_tree, $p_system_module = true, $p_parent = null)
    {
        ...
        else
        {
            $l_root = $p_tree->add_node(
                C__MODULE__LOGBOOK . '0',
                $l_parent,
                $g_comp_template_language_manager->get('LC__CMDB__CATG__LOGBOOK')
            );
        } // if
        ...
        $p_tree->add_node(
            ...
            $l_root,
            $g_comp_template_language_manager->get('LC__CMDB__LOGBOOK__LIST_CONTENT_TITLE'),
            '?' . C__GET__MODULE_ID . '=' . $_GET[C__GET__MODULE_ID] . $l_submodule . '&' . C__GET__TREE_NODE . '=' . C__MODULE__LOGBOOK . C__PAGE__LOGBOOK_VIEW . '&' . C__GET__SETTINGS_PAGE . '=' . C__PAGE__LOGBOOK_VIEW . '&' . C__GET__MAIN_MENU__NAVIGATION_ID . '=6',
            '',
        ...
        $p_tree->add_node(
            ...
            $l_root,
            $g_comp_template_language_manager->{"LC__MODULE__CMDB__LOGBOOK_CONFIGURATION"},
            '?' . C__GET__MODULE_ID . '=' . $_GET[C__GET__MODULE_ID] . $l_submodule . '&' . C__GET__TREE_NODE . '=' . C__MODULE__LOGBOOK . C__PAGE__LOGBOOK_CONFIGURATION . '&' . C__GET__SETTINGS_PAGE . '=' . C__PAGE__LOGBOOK_CONFIGURATION . '&' . C__GET__MAIN_MENU__NAVIGATION_ID . '=6',
            null,
        ...
        $p_tree->add_node(
            ...
            $l_root,
            $g_comp_template_language_manager->get('LC__NAVIGATION__NAVBAR__ARCHIVE'),
            '?' . C__GET__MODULE_ID . '=' . $_GET[C__GET__MODULE_ID] . $l_submodule . '&' . C__GET__TREE_NODE . '=' . C__MODULE__LOGBOOK . C__PAGE__LOGBOOK_ARCHIVE . '&' . C__GET__SETTINGS_PAGE . '=' . C__PAGE__LOGBOOK_ARCHIVE . '&' . C__GET__MAIN_MENU__NAVIGATION_ID . '=6',
            null,
        ...
        $p_tree->add_node(
            ...
            $l_root,
            $g_comp_template_language_manager->get('LC__UNIVERSAL__RESTORE'),
            '?' . C__GET__MODULE_ID . '=' . $_GET[C__GET__MODULE_ID] . $l_submodule . '&' . C__GET__TREE_NODE . '=' . C__MODULE__LOGBOOK . C__PAGE__LOGBOOK_RESTORE . '&' . C__GET__SETTINGS_PAGE . '=' . C__PAGE__LOGBOOK_RESTORE . '&' . C__GET__MAIN_MENU__NAVIGATION_ID . '=6',
            null,
    ...
    public function start()
    {
        ...
        /* Set memory limit */
        if (($l_memlimit = isys_settings::get('system.memory-limit.search', '768M')))
        {
    ...
    public function prepare_changes($p_dao, $p_dataset_from = null, $p_category_values = null)
    {
        ...
        {
            if ((!$l_prop_info[C__PROPERTY__PROVIDES][C__PROPERTY__PROVIDES__IMPORT] && isset($l_category_values[$l_key])) || !isset($l_category_values[$l_key])) continue;
            ...
            if (isset($l_prop_info[C__PROPERTY__FORMAT][C__PROPERTY__FORMAT__CALLBACK][1]))
            {
                switch ($l_prop_info[C__PROPERTY__FORMAT][C__PROPERTY__FORMAT__CALLBACK][1])
                {
                    ...
                    case 'get_yes_or_no':
                        ...
                        else if (isset($l_prop_info[C__PROPERTY__DATA][C__PROPERTY__DATA__REFERENCES]))
                        {
                            $l_field = ((isset($l_prop_info[C__PROPERTY__DATA][C__PROPERTY__DATA__FIELD_ALIAS])) ? $l_prop_info[C__PROPERTY__DATA][C__PROPERTY__DATA__FIELD_ALIAS] : $l_prop_info[C__PROPERTY__DATA][C__PROPERTY__DATA__REFERENCES][0] . '__title');
                        } // if
                        break;
                    case 'location':
                    case 'object':
                    ...
                    case 'connection':
                        ...
                        break;
                    case 'contact':
                        $l_res_from = $p_dao->retrieve(
                            'SELECT isys_contact_2_isys_obj__isys_obj__id FROM isys_contact_2_isys_obj WHERE isys_contact_2_isys_obj__isys_contact__id = ' . $p_dao->convert_sql_id(
                                $p_dataset_from[$l_field]
                            ) . ' ORDER BY isys_contact_2_isys_obj__isys_obj__id ASC'
                        );
                        ...
                        $l_res_to = $p_dao->retrieve(
                            'SELECT isys_contact_2_isys_obj__isys_obj__id FROM isys_contact_2_isys_obj WHERE isys_contact_2_isys_obj__isys_contact__id = ' . $p_dao->convert_sql_id(
                                $l_category_values[$l_key]['value']
                            ) . ' ORDER BY isys_contact_2_isys_obj__isys_obj__id ASC'
                        );
                    ...
                    default:
                        ...
                        if (isset($p_dataset_from))
                        {
                            ...
                            if (is_array($l_helper_value_data) > 0)
                            {
                                ...
                                {
                                    if ($l_prop_info[C__PROPERTY__FORMAT][C__PROPERTY__FORMAT__CALLBACK][1] == 'get_ip_reference')
                                    {
                        ...
                        {
                            $l_query = 'SELECT ' . $l_category_values[$l_key]['reference'] . '__title FROM ' . $l_category_values[$l_key]['reference'] . ' WHERE ' . $l_category_values[$l_key]['reference'] . '__id = ';
                            if (isset($l_from))
                            {
                        ...
                        if (($l_prop_info[C__PROPERTY__FORMAT][C__PROPERTY__FORMAT__CALLBACK][1] == 'get_net_dns_server' || $l_prop_info[C__PROPERTY__FORMAT][C__PROPERTY__FORMAT__CALLBACK][1] == 'get_ip_reference') && (!empty($l_from) || !empty($l_to)))
                        {
                            $l_query = 'SELECT isys_cats_net_ip_addresses_list__title FROM isys_cats_net_ip_addresses_list ' . 'INNER JOIN isys_catg_ip_list ON isys_catg_ip_list__isys_cats_net_ip_addresses_list__id = isys_cats_net_ip_addresses_list__id ' . 'WHERE isys_catg_ip_list__id = ';
            ...
            else if (!isset($l_from) && !isset($l_to))
            {
                if (isset($l_prop_info[C__PROPERTY__FORMAT][C__PROPERTY__FORMAT__CALLBACK][1]) && ($l_prop_info[C__PROPERTY__FORMAT][C__PROPERTY__FORMAT__CALLBACK][1] == 'dialog' || $l_prop_info[C__PROPERTY__FORMAT][C__PROPERTY__FORMAT__CALLBACK][1] == 'dialog_plus'))
                {

                    if (isset($p_dataset_from) && array_key_exists($l_field, $p_dataset_from))
                    {
                        if (is_numeric($p_dataset_from[$l_field]))
                        {
                            $l_from_data = $p_dao->get_dialog($l_prop_info[C__PROPERTY__DATA][C__PROPERTY__DATA__REFERENCES][0], $p_dataset_from[$l_field])
                                ->__to_array();
                    ...
                    if ($l_category_values[$l_key]['title_lang'])
                    {
                    ...
                    {
                        $l_to_data = $p_dao->get_dialog($l_prop_info[C__PROPERTY__DATA][C__PROPERTY__DATA__REFERENCES][0], $l_category_values[$l_key]['value'])
                            ->__to_array();
                        $l_to      = $l_to_data[$l_prop_info[C__PROPERTY__DATA][C__PROPERTY__DATA__REFERENCES][0] . '__title'];
                    }
                }
                else if (!$l_has_callback)
                {
                    $l_from = $p_dataset_from[$l_field];
            ...
            {
                $l_formatted_from = trim(_L($l_from));
                $l_formatted_to   = trim(_L($l_to));
    ...
    protected function processDetailView()
    {
        ...
        $l_ui_logbook = new isys_cmdb_ui_category_g_logb($g_comp_template);
        ...
        /**
         * @todo set $l_nObjID to ISYS_NULL if object is deleted!
         */
        if ($l_nObjID)
        {
            ...
            $l_CatgID     = C__CATG__LOGBOOK;
            $l_nCatID     = $l_lbRow["isys_catg_logb_list__id"];

            $l_strURL = "index.php" . "?moduleID=" . C__MODULE__CMDB . "&objTypeID=$l_nObjTypeID" . "&viewMode=$l_nViewMode" . "&tvMode=$l_nTreeMode" . "&objID=$l_nObjID" . "&catgID=$l_CatgID" . "&cateID=$l_nCatID";
        ...
        $l_rules["C__CMDB__LOGBOOK__LEVEL"]["p_strValue"]       = $g_comp_template_language_manager->get($l_lbRow["isys_logbook_level__title"]);
        ...
        try
        {
            ...
            if (isys_glob_get_param("filter_archive") == "1")
            {
                try
                {
                    ...
                    $l_objList = new isys_component_list_logbook(ISYS_NULL, $l_listres, $l_daoArchive);
                }
                catch (Exception $e)
                {
                    $g_comp_template->assign("content_title", _L("LC__CMDB__LOGBOOK__LIST_CONTENT_TITLE"))
            ...
            $l_arTableHeader = [
                ...
                "isys_logbook__user_name_static" => _L('LC__CMDB__LOGBOOK__SOURCE__USER'),
                "isys_logbook__obj_name_static"  => _L('LC__CMDB__LOGBOOK__SOURCE__OBJECT'),
                "isys_logbook__date"             => _L('LC__CMDB__LOGBOOK__DATE'),
                "isys_logbook_level__title"      => _L('LC__CMDB__LOGBOOK__LEVEL'),
                "isys_logbook_source__title"     => _L('LC__CMDB__LOGBOOK__SOURCE')
            ];

            $l_objList->config($l_arTableHeader, $l_strRowLink);
            isys_component_template_navbar::getInstance()
                ->set_nav_page_count($l_navPageCount);
     ...
     * @return  integer
     */
    protected function fetch_object_name_by_id($p_id, $p_dao)
    {
        if (!is_array($this->m_objects) || !array_key_exists((int) $p_id, $this->m_objects))
        {
            $this->m_objects[$p_id] = $p_dao->get_obj_name_by_id_as_string($p_id);
        } //if
            ...
            default:
                ...
                switch ($l_settings_page)
                {
                    case C__PAGE__LOGBOOK_ARCHIVE:
                        ...
                        $g_comp_template->assign("index_includes", $index_includes);
                        $g_comp_template->assign("navbar", $l_navbar->show_navbar());

                        $g_comp_template->display("content/main_groups.tpl");
                        break;
                    case C__PAGE__LOGBOOK_CONFIGURATION:
                        $this->processConfiguration();
                        $g_comp_template->assign("index_includes", $index_includes);
                    ...
                    default:
                        ...
                        {
                            echo isys_glob_utf8_encode("Error processing AJAX request");
                        }
                        break;
                }
    ...
    private function expandLogbookEntry()
    {
        ...
        {
            global $g_comp_database, $g_comp_template, $g_db_system;

            $l_cmdb_ui = new isys_cmdb_ui_category_g_logb($g_comp_template);
    ...
    private function restoreLogbook()
    {
        ...
        {
            echo isys_glob_utf8_encode("<p style=\"color:#ff0000;\">Could not connect to " . $_POST["archiveHost"] . "</p>");
            die;
        }
        ...
        try
        {
            if (!$l_db->is_table_existent("isys_archive_logbook")) throw new Exception("No archive data found");

            // start restoring
            $l_daoArchive->restore(new isys_component_dao($g_comp_database), $l_date, $_POST["archiveSource"] == "0");
            echo isys_glob_utf8_encode("Restore successful");
        }
        catch (Exception $e)
        {
            echo isys_glob_utf8_encode("<p>" . $e->getMessage() . "</p>");
            die;
        }
    } // function
    ...
    {
        global $index_includes, $g_comp_template, $g_comp_session, $g_comp_database;
        ...
        switch ($_POST[C__GET__NAVMODE])
        {
            ...
            case C__NAVMODE__SAVE:
                ...
                isys_settings::set('logbook.changes.multivalue-threshold', $_POST['C__MODULE__CMDB__LOGBOOK_CONFIGURATION__MULTIVALUE_THRESHOLD']);
            ...
            default:
                isys_component_template_navbar::getInstance()
                    ->set_active(
                        isys_auth_logbook::instance()
                            ->is_allowed_to(isys_auth::EDIT, 'LOGBOOK/' . C__MODULE__LOGBOOK . C__PAGE__LOGBOOK_CONFIGURATION),
        ...
        $g_comp_template->assign('multivalue_threshold', isys_settings::get('logbook.changes.multivalue-threshold', 25))
            ->assign('content_title', _L('LC__MODULE__CMDB__LOGBOOK_CONFIGURATION'))
        ...
        if (!empty($l_config))
        {
            $g_comp_template->assign('default_checked', (($l_config['isys_logbook_configuration__type'] == 0) ? true : false))
                ->assign('advanced_checked', (($l_config['isys_logbook_configuration__type'] == 1) ? true : false))
                ->assign(
                    'placeholder_string',
                    (!empty($l_config['isys_logbook_configuration__placeholder_string']) ? $l_config['isys_logbook_configuration__placeholder_string'] : _L(
                        'LC__NAVIGATION__BREADCRUMB__NO_TITLE'
                    ))
                );
        }
    ...
    private function processArchive()
    {
        ...
        if ($_POST["navMode"] == C__NAVMODE__SAVE)
        {
            ...
            $g_comp_template->assign("archiveDest", $_POST["archiveDest"]);
        } // if
        ...
        $l_rules = [
            ...
            'archiveDest'     => [
                ...
                'p_arData'        => [
                    "0" => _L("LC__UNIVERSAL__DATABASE_LOCAL"),
                    "1" => _L("LC__UNIVERSAL__DATABASE_REMOTE")
                ],
        ...
        $g_comp_template->assign('archiveDest', $l_ad['dest'])
            ->assign('archiveError', $l_error)
            ->assign('content_title', _L('LC__NAVIGATION__NAVBAR__ARCHIVE'))
    ...
    private function processRestore()
    {
        ...
        $l_rules["archiveSource"]["p_arData"] = serialize(
            [
                "0" => _L("LC__UNIVERSAL__DATABASE_LOCAL"),
                "1" => _L("LC__UNIVERSAL__DATABASE_REMOTE")
            ]
        ...
        $l_rules["restoreFrom"]["p_strValue"]        = $l_ad["interval"];
        $l_rules["archiveHost"]["p_strValue"]        = $l_ad["host"];
        $l_rules["archivePort"]["p_strValue"]        = $l_ad["port"];
        $l_rules["archiveDB"]["p_strValue"]          = $l_ad["db"];
        $l_rules["archiveUser"]["p_strValue"]        = $l_ad["user"];
        $l_rules["archivePass"]["p_strValue"]        = $l_ad["pass"];
        $l_rules["archiveSource"]["p_strSelectedID"] = $l_ad["dest"];

        // Removed: isys_rs_system
        $l_rules["buttonRestore"]["p_bDisabled"] = 0;

        $g_comp_template->assign("btnLabelExecute", _L("LC__UNIVERSAL__EXECUTE"))
            ->assign("archiveDest", $l_ad["dest"])
            ->assign("content_title", _L("LC__UNIVERSAL__RESTORE"))
            ->smarty_tom_add_rule("tom.content.bottom.buttons.*.p_bInvisible=1")
            ->smarty_tom_add_rules("tom.content.bottom.content", $l_rules);

        $index_includes["contentbottomcontent"] = "content/bottom/content/module__logbook__restore.tpl";
    } // function
    ...
    private function setupFilter($p_daoLogbook)
    {
        ...
        $l_rules = [
            'filter_source'  => [
                'p_arData'   => serialize($l_sourceFilter),
                'p_strClass' => 'input-mini'
            ],
            'filter_alert'   => [
                'p_arData'   => serialize($l_alertFilter),
                'p_strClass' => 'input-mini'
            ],
            'filter_type'    => [
                'p_arData'   => serialize($l_typeFilter),
                'p_strClass' => 'input-mini'
            ],
            'filter_archive' => [
                'p_arData'   => serialize(
                    [
                        "0" => _L("LC__RECORD_STATUS__NORMAL"),
                        "1" => _L("LC__UNIVERSAL__ARCHIVE")
                    ]
                ),
                'p_strClass' => 'input-mini'
            ]
