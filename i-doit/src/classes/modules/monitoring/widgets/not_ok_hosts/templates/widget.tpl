...
[{if $error}]
	<div class="warning m5 p5"><img src="[{$dir_images}]icons/silk/error.png" class="vam mr5" /><span class="vam">[{$error}]</span></div>
[{else}]
	[{if count($hosts)}]
		<p class="p5 yellow"><img src="[{$dir_images}]icons/silk/error.png" class="vam mr5" />[{isys type="lang" ident="LC__MONITORING__WIDGET__NOT_OK_HOSTS__FOUND_HOSTS_THAT_ARE_NOT_OK"}]</p>

		<div class="p5">
			<table class="mainTable border border-ccc">
				<thead>
				<tr>
	...
	[{elseif count($services)}]
		<p class="p5 yellow"><img src="[{$dir_images}]icons/silk/error.png" class="vam mr5" />[{isys type="lang" ident="LC__MONITORING__WIDGET__NOT_OK_HOSTS__FOUND_SERVICES_THAT_ARE_NOT_OK"}]</p>
