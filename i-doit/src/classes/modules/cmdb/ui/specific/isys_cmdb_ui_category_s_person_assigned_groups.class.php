...
class isys_cmdb_ui_category_s_person_assigned_groups extends isys_cmdb_ui_category_specific
{
     ...
     * Process method.
     *
     * @param   isys_cmdb_dao_category_s_person_assigned_groups $p_cat
     *
     * @return  boolean
     */
    public function process_list(isys_cmdb_dao_category_s_person_assigned_groups $p_cat)
    {
        $l_params = [
        ...
        isys_component_template_navbar::getInstance()
            ...
            ->set_title(_L('LC__CMDB__CATS__PERSON__ATTACH_GROUPS'), C__NAVBAR_BUTTON__NEW)
            ->set_tooltip(_L('LC__CMDB__CATS__PERSON__ATTACH_GROUPS'), C__NAVBAR_BUTTON__NEW)
        ...
        $this->list_view(
            ...
            $_GET[C__CMDB__GET__OBJECT],
            new isys_cmdb_dao_list_cats_person_assigned_groups($p_cat->get_database_component()),
            null,
            null,
            null,
            false
