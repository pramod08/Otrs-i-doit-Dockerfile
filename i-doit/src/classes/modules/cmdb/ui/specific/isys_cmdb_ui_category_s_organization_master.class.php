...
class isys_cmdb_ui_category_s_organization_master extends isys_cmdb_ui_category_specific
{
    ...
    public function process(isys_cmdb_dao_category $p_cat)
    {
        ...
        // Make rules
        $l_rules["C__CMDB__CAT__COMMENTARY_" . $p_cat->get_category_type() . C__CATS__ORGANIZATION]["p_strValue"]             = $l_catdata["isys_cats_organization_list__description"];
        $l_rules["C__CMDB__CAT__COMMENTARY_" . $p_cat->get_category_type() . C__CATS__ORGANIZATION_MASTER_DATA]["p_strValue"] = $l_catdata["isys_cats_organization_list__description"];
