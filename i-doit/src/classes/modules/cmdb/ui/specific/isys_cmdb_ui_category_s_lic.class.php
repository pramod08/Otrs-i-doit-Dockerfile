...
class isys_cmdb_ui_category_s_lic extends isys_cmdb_ui_category_specific
{
    ...
    public function process(isys_cmdb_dao_category $p_cat)
    {
        ...
        while ($l_row = $l_licence_res->get_row())
        {
            ...
            $l_objects[$l_row['client_obj_id']] = [
                'type'          => _L($p_cat->get_objtype_name_by_id_as_string($l_row['client_obj_type'])),
        ...
        $l_rules['C__CATS__LICENCE_TYPE']['p_arData'] = serialize($p_cat->callback_property_type(isys_request::factory()));
    ...
    {
        return parent::process_list($p_cat, [C__CMDB__GET__CATS => C__CMDB__SUBCAT__LICENCE_LIST], null, null, true, true, "isys_cats_lic_list__id");
    } // function
} // class