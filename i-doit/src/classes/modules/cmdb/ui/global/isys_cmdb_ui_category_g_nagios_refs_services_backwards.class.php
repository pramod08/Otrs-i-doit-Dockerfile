 ...
 * @license     http://www.i-doit.com/license
 */
class isys_cmdb_ui_category_g_nagios_refs_services_backwards extends isys_cmdb_ui_category_global
{
    /**
     * @param   isys_cmdb_dao_category_g_nagios_refs_services_backwards $p_cat
     *
     * @return  null
     */
     ...
     * @return  boolean
     */
    public function process_list(isys_cmdb_dao_category_g_nagios_refs_services_backwards $p_cat)
    {
        $l_params = [
            isys_popup_browser_object_ng::C__MULTISELECTION => true,
            isys_popup_browser_object_ng::C__FORM_SUBMIT    => true,
            isys_popup_browser_object_ng::C__RETURN_ELEMENT => C__POST__POPUP_RECEIVER,
            isys_popup_browser_object_ng::C__CAT_FILTER     => 'C__CATG__NAGIOS_HOST_FOLDER;C__CATG__NAGIOS_REFS_SERVICES',
        ...
        $this->list_view("isys_obj__id", $_GET[C__CMDB__GET__OBJECT], new isys_cmdb_dao_list_catg_nagios_refs_services_backwards($this->get_database_component()));
