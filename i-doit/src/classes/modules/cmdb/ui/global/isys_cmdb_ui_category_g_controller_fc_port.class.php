...
class isys_cmdb_ui_category_g_controller_fc_port extends isys_cmdb_ui_category_global
{
    ...
    public function process(isys_cmdb_dao_category $p_cat)
    {
        ...
        $l_speed = isys_convert::speed(
            $l_catdata["isys_catg_fc_port_list__port_speed"],
            $l_catdata["isys_catg_fc_port_list__isys_port_speed__id"],
        ...
        $l_rules["C__CMDB__CATS__SAN_ZONE"]["p_strSelFCPort"]  = isys_format_json::encode(
            $l_dao_zoning->get_selected_fc_ports_by_fc_port_id($l_catdata["isys_catg_fc_port_list__id"])
        );
        $l_rules["C__CMDB__CATS__SAN_ZONE"]["p_strSelWWN"]     = isys_format_json::encode(
            $l_dao_zoning->get_selected_wwns_by_fc_port_id($l_catdata["isys_catg_fc_port_list__id"])
        );
