...
class isys_cmdb_ui_category_g_service extends isys_cmdb_ui_category_global
{
    ...
    public function process(isys_cmdb_dao_category $p_cat)
    {
        ...
        $l_role_title = _L(
            $l_dao_contact->get_contact_tag_data(C__CONTACT_TYPE__SERVICE_MANAGER)
        ...
        else
        {
            ...
            $this->get_template_component()
                ->assign(
                    'contacts',
                    '<img class="vam" src="images/icons/infobox/blue.png"><span class="ml5">' . sprintf(
                        _L('LC__CMDB__CATG__SERVICE__NO_CONTACTS_FOUND'),
                        $l_role_title
                    ) . '</span>'
                );
        } // if
