...
class isys_cmdb_ui_category_g_rm_controller_backward extends isys_cmdb_ui_category_global
{
     ...
     */
    public function process_list(isys_cmdb_dao_category &$p_cat, $p_get_param_override = null, $p_strVarName = null, $p_strTemplateName = null, $p_bCheckbox = false, $p_bOrderLink = true, $p_db_field_name = null)
    {
        $this->object_browser_as_new(
            [
                ...
                isys_popup_browser_object_ng::C__DATARETRIEVAL  => [
                    [
                        'isys_cmdb_dao_category_g_rm_controller_backward',
