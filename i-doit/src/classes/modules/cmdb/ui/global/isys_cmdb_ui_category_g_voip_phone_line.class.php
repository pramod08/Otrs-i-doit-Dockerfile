...
class isys_cmdb_ui_category_g_voip_phone_line extends isys_cmdb_ui_category_global
{
     ...
     * Process method.
     *
     * @param   isys_cmdb_dao_category_g_voip_phone_line $p_cat
     *
     ...
     * @author  Leonard Fischer <lfischer@i-doit.org>
     */
    public function process_list(isys_cmdb_dao_category_g_voip_phone_line $p_cat)
    {
        $this->list_view("isys_catg_voip_phone_line", $_GET[C__CMDB__GET__OBJECT], new isys_cmdb_dao_list_catg_voip_phone_line($p_cat));
