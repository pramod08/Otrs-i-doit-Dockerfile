...
class isys_cmdb_ui_category_g_cluster_service extends isys_cmdb_ui_category_global
{
    ...
    public function process(isys_cmdb_dao_category $p_cat)
    {
        ...
        $l_request = isys_request::factory()
            ->set_category_type(C__CATG__CLUSTER_SERVICE)
        ...
        $l_rules["C__CMDB__CATG__CLUSTER_SERVICE__RUNS_ON"]["p_arData"] = serialize($l_runs_on);

        // Default server dialog hack.
        $l_rules["C__CMDB__CATG__CLUSTER_SERVICE__DEFAULT_SERVER"]["p_arData"]        = serialize($l_default_server);
    ...
    public function process_options(isys_cmdb_dao_category_g_cluster_service $p_cat)
    {
        ...
        $g_comp_template->display("content/bottom/content/catg__cluster_service_options.tpl");
        die;
    } // function
} // class