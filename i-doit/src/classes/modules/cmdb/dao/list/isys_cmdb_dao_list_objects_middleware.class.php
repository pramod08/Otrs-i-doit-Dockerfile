 ...
 * @since       0.9.9-9
 */
class isys_cmdb_dao_list_objects_middleware extends isys_cmdb_dao_list_objects
{
    /**
    ...
    public function get_default_list_query()
    {
        return "SELECT
			...
			jn3.isys_application_manufacturer__title,
			j5.isys_cats_application_list__release,
			...
			LEFT JOIN isys_cats_application_list AS j5 ON j5.isys_cats_application_list__isys_obj__id = obj_main.isys_obj__id
			LEFT JOIN isys_application_manufacturer AS jn3 ON jn3.isys_application_manufacturer__id = j5.isys_cats_application_list__isys_application_manufacturer__id

			WHERE (obj_main.isys_obj__isys_obj_type__id = " . $this->convert_sql_id(C__OBJTYPE__MIDDLEWARE) . ") ";
    } // function
} // class