 ...
 * @since       0.9.9-9
 */
class isys_cmdb_dao_list_objects_application extends isys_cmdb_dao_list_objects
{
    /**
    ...
    {
        return '[[' . C__PROPERTY_TYPE__DYNAMIC . ',"_id",false,"LC__CMDB__OBJTYPE__ID","isys_cmdb_dao_category_g_global::get_dynamic_properties",["isys_cmdb_dao_category_g_global","dynamic_property_callback_id"]],' . '[' . C__PROPERTY_TYPE__DYNAMIC . ',"_title",false,"LC__UNIVERSAL__TITLE_LINK","isys_cmdb_dao_category_g_global::get_dynamic_properties",["isys_cmdb_dao_category_g_global","dynamic_property_callback_title"]],' . //'[' . C__PROPERTY_TYPE__STATIC . ',"manufacturer","isys_application_manufacturer__title","LC__CMDB__CATG__MANUFACTURE","isys_cmdb_dao_category_s_application::get_properties",false],' .
        //'[' . C__PROPERTY_TYPE__STATIC . ',"release","isys_cats_application_list__release","LC__CMDB__CATS__SERVICE_RELEASE","isys_cmdb_dao_category_s_application::get_properties",false],' .
        //'[' . C__PROPERTY_TYPE__STATIC . ',"specification","isys_cats_application_list__specification","LC__CMDB__CATS__SERVICE_SPECIFICATION","isys_cmdb_dao_category_s_application::get_properties",false],' .
    ...
    public function get_default_list_query()
    {
        return "SELECT
			...
			WHERE (obj_main.isys_obj__isys_obj_type__id = " . $this->convert_sql_id(C__OBJTYPE__APPLICATION) . ") ";
    } // function
} // class