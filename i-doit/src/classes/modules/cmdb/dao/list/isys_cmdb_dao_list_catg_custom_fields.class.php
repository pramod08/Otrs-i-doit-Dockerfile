...
class isys_cmdb_dao_list_catg_custom_fields extends isys_cmdb_dao_list implements isys_cmdb_dao_list_interface
{
    ...
    public function make_row_link()
    {
        ...
        $l_edit_right = isys_auth_cmdb::instance()
            ->has_rights_in_obj_and_category(isys_auth::EDIT, $_GET[C__CMDB__GET__OBJECT], 'C__CATG__CUSTOM_FIELDS');
                                ...
                                case C__TYPE__INT:
                                    switch ($l_property[C__PROPERTY__UI][C__PROPERTY__UI__PARAMS]['popup'])
                                    {
                                        case 'browser_object':
                                            ...
                                            {
                                                if (!isset($l_already_used_keys[$l_val['isys_catg_custom_fields_list__field_key'] . '+' . $l_val['isys_catg_custom_fields_list__data__id']]))
                                                {
                                                    ...
                                                    {
                                                        $l_arr[$l_counter][$l_prop_key] .= '<li>- ' . $l_quicklink->get_quick_info(
                                                                $l_obj_id,
                                                    ...
                                                    $l_arr[$l_counter][$l_prop_key] .= '</ul>';
                                                    $l_already_used_keys[$l_val['isys_catg_custom_fields_list__field_key'] . '+' . $l_val['isys_catg_custom_fields_list__data__id']] = true;
                                                } // if
                                            }
                                            else
                                            {
