 ...
 * @since       0.9.9-9
 */
class isys_cmdb_dao_list_objects_san_zoning extends isys_cmdb_dao_list_objects
{
    /**
    ...
    public function get_default_list_query()
    {
        return "SELECT
			...
			WHERE (obj_main.isys_obj__isys_obj_type__id = " . $this->convert_sql_id(C__OBJTYPE__SAN_ZONING) . ") ";
    } // function
} // class