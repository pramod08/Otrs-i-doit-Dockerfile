 ...
 * @since       0.9.9-9
 */
class isys_cmdb_dao_list_objects_contract extends isys_cmdb_dao_list_objects
{
    /**
    ...
    public function get_default_list_query()
    {
        return "SELECT
			...
			jn3.isys_contract_type__title,
			j6.isys_cats_contract_list__start_date,
			j6.isys_cats_contract_list__end_date,
			...
			LEFT JOIN isys_cats_contract_list AS j6 ON j6.isys_cats_contract_list__isys_obj__id = obj_main.isys_obj__id
			LEFT JOIN isys_contract_type AS jn3 ON jn3.isys_contract_type__id = j6.isys_cats_contract_list__isys_contract_type__id

			WHERE (obj_main.isys_obj__isys_obj_type__id = " . $this->convert_sql_id(C__OBJTYPE__MAINTENANCE) . ") ";
    } // function
} // class