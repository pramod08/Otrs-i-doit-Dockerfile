 ...
 * @since       0.9.9-9
 */
class isys_cmdb_dao_list_objects_database_instance extends isys_cmdb_dao_list_objects
{
    /**
    ...
    public function get_default_list_query()
    {
        return "SELECT
			...
			j4.isys_cats_database_instance_list__title,
			j4.isys_cats_database_instance_list__listener,
			...
			LEFT JOIN isys_cats_database_instance_list AS j4 ON j4.isys_cats_database_instance_list__isys_obj__id = obj_main.isys_obj__id

			WHERE (obj_main.isys_obj__isys_obj_type__id = " . $this->convert_sql_id(C__OBJTYPE__DATABASE_INSTANCE) . ") ";
    } // function
} // class