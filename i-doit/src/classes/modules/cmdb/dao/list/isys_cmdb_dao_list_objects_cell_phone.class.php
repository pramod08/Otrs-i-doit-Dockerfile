 ...
 * @since       0.9.9-9
 */
class isys_cmdb_dao_list_objects_cell_phone extends isys_cmdb_dao_list_objects
{
    /**
    ...
    public function get_default_list_query()
    {
        return "SELECT
			...
			jn3.isys_model_manufacturer__title,
			jn5.isys_model_title__title,
			j7.isys_catg_model_list__serial,
			j8.isys_cats_mobile_phone_list__imei_number,
			...
			LEFT JOIN isys_model_manufacturer AS jn3 ON jn3.isys_model_manufacturer__id = j7.isys_catg_model_list__isys_model_manufacturer__id
			LEFT JOIN isys_model_title AS jn5 ON jn5.isys_model_title__id = j7.isys_catg_model_list__isys_model_title__id
			LEFT JOIN isys_cats_mobile_phone_list AS j8 ON j8.isys_cats_mobile_phone_list__isys_obj__id = obj_main.isys_obj__id

			WHERE (obj_main.isys_obj__isys_obj_type__id = " . $this->convert_sql_id(C__OBJTYPE__CELL_PHONE_CONTRACT) . ") ";
    } // function
} // class