 ...
 * @since       0.9.9-9
 */
class isys_cmdb_dao_list_objects_kryptocard extends isys_cmdb_dao_list_objects
{
    /**
    ...
    public function get_default_list_query()
    {
        return "SELECT
			...
			j5.isys_cats_krypto_card_list__date_of_issue,
			j5.isys_cats_krypto_card_list__certgate_card_number,
			j5.isys_cats_krypto_card_list__imei_number,
			...
			LEFT JOIN isys_cats_krypto_card_list AS j5 ON j5.isys_cats_krypto_card_list__isys_obj__id = obj_main.isys_obj__id

			WHERE (obj_main.isys_obj__isys_obj_type__id = " . $this->convert_sql_id(C__OBJTYPE__KRYPTO_CARD) . ") ";
    } // function
} // class