...
class isys_cmdb_dao_category_s_organization extends isys_cmdb_dao_category_specific
{
     ...
     */
    protected $m_category_id = C__CATS__ORGANIZATION;
    ...
    public function get_data($p_cats_list_id = null, $p_obj_id = null, $p_condition = "", $p_filter = null, $p_status = null)
    {
        ...
        $l_sql = "SELECT * FROM isys_cats_organization_list " .
            ...
            "INNER JOIN isys_obj " . "ON " . "isys_cats_organization_list__isys_obj__id = isys_obj__id " . "LEFT JOIN isys_connection " . "ON isys_cats_organization_list__isys_connection__id = isys_connection__id " .
    ...
    public function save_element($p_cat_level, &$p_intOldRecStatus)
    {
        ...
        if (empty($l_list_id)) $l_list_id = $this->create_connector("isys_cats_organization_list", $_GET[C__CMDB__GET__OBJECT]);
    ...
    public function save($p_catlevel, $p_status = C__RECORD_STATUS__NORMAL, $p_title = null, $p_street = null, $p_zip_code = null, $p_city = null, $p_country = null, $p_telephone = null, $p_fax = null, $p_website = null, $p_headquarter = null, $p_description = null)
    {
        return;
        ...
        $l_sql = "UPDATE isys_cats_organization_list " . "INNER JOIN isys_obj ON isys_obj__id = isys_cats_organization_list__isys_obj__id " . "SET " . "isys_obj__status = " . $this->convert_sql_id(
                $p_status
            ) . ", " . "isys_obj__title = " . $this->convert_sql_text($p_title) . ", " . "isys_cats_organization_list__title= " . $this->convert_sql_text(
                $p_title
            ) . ", " . "isys_cats_organization_list__status = " . $this->convert_sql_id($p_status) . ", " . "isys_cats_organization_list__street = " . $this->convert_sql_text(
                $p_street
            ) . ", " . "isys_cats_organization_list__zip_code = " . $this->convert_sql_text(
                $p_zip_code
            ) . ", " . "isys_cats_organization_list__city = " . $this->convert_sql_text($p_city) . ", " . "isys_cats_organization_list__country = " . $this->convert_sql_text(
                $p_country
            ) . ", " . "isys_cats_organization_list__telephone = " . $this->convert_sql_text(
                $p_telephone
            ) . ", " . "isys_cats_organization_list__fax =" . $this->convert_sql_text($p_fax) . ", " . "isys_cats_organization_list__website =" . $this->convert_sql_text(
                $p_website
            ) . ", " . "isys_cats_organization_list__isys_connection__id =" . $this->convert_sql_id(
                $l_id
