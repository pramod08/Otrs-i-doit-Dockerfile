...
class isys_cmdb_dao_category_s_database_objects extends isys_cmdb_dao_category_specific
{
    ...
    public function get_data($p_cats_list_id = null, $p_obj_id = null, $p_condition = "", $p_filter = null, $p_status = null)
    {
        ...
        $l_sql = "SELECT * FROM isys_cats_database_objects_list " . "INNER JOIN isys_obj ON isys_obj__id = isys_cats_database_objects_list__isys_obj__id " . "LEFT JOIN isys_database_objects ON isys_database_objects__id = isys_cats_database_objects_list__isys_database_objects__id " . "WHERE TRUE ";
    ...
    protected function properties()
    {
        return [
            ...
            'database_object' => array_replace_recursive(
            ...
            'description'     => array_replace_recursive(
                ...
                [
                    ...
                    C__PROPERTY__UI   => [
                        C__PROPERTY__UI__ID => 'C__CMDB__CAT__COMMENTARY_' . C__CMDB__CATEGORY__TYPE_SPECIFIC . C__CATS__DATABASE_OBJECTS
                    ]
                ]
            )
        ];
        ...
        if (is_array($p_category_data) && isset($p_category_data['properties']))
        {
            ...
            if ($p_status === isys_import_handler_cmdb::C__CREATE || $p_status === isys_import_handler_cmdb::C__UPDATE)
            {
                ...
                $l_indicator = $this->save(
                    ...
                    $p_category_data['properties']['database_object'][C__DATA__VALUE],
    ...
    public function save($p_id, $p_type_id, $p_title, $p_description, $p_status = C__RECORD_STATUS__NORMAL)
    {
        ...
        $l_strSql = "UPDATE isys_cats_database_objects_list " . "SET " . "isys_cats_database_objects_list__isys_database_objects__id = " . $this->convert_sql_id(
                $p_type_id
            ) . ", " . "isys_cats_database_objects_list__title = " . $this->convert_sql_text(
                $p_title
            ) . ", " . "isys_cats_database_objects_list__description = " . $this->convert_sql_text(
                $p_description
            ) . ", " . "isys_cats_database_objects_list__status = " . $this->convert_sql_id($p_status) . " " .
    ...
    public function create($p_object_id, $p_type_id, $p_title, $p_description, $p_status = C__RECORD_STATUS__NORMAL)
    {
        ...
        $l_sql = "INSERT INTO isys_cats_database_objects_list " . "SET isys_cats_database_objects_list__isys_obj__id = " . $this->convert_sql_id(
                $p_object_id
            ) . ", " . "isys_cats_database_objects_list__isys_database_objects__id = " . $this->convert_sql_id(
                $p_type_id
            ) . ", " . "isys_cats_database_objects_list__description = " . $this->convert_sql_text(
                $p_description
            ) . ", " . "isys_cats_database_objects_list__title = " . $this->convert_sql_text(
    ...
    public function save_element($p_cat_level, &$p_status, $p_create = false)
    {
        ...
        $l_bRet = $this->save(
            $l_list_id,
            $_POST["C__CMDB__CATS__DATABASE_OBJECTS__TYPE"],
            $_POST["C__CMDB__CATS__DATABASE_OBJECTS__TITLE"],
