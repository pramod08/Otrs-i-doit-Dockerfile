...
class isys_cmdb_dao_category_s_database_instance extends isys_cmdb_dao_category_specific
{
    ...
    public function get_data($p_cats_list_id = null, $p_obj_id = null, $p_condition = "", $p_filter = null, $p_status = null)
    {
        ...
        $l_sql = "SELECT * FROM isys_cats_database_instance_list " . "INNER JOIN isys_obj " . "ON " . "isys_obj__id = " . "isys_cats_database_instance_list__isys_obj__id " . "INNER JOIN isys_connection " . "ON " . "isys_connection__id = " . "isys_cats_database_instance_list__isys_connection__id " . "WHERE TRUE ";
    ...
    {
        return [
            'instance'        => array_replace_recursive(
                ...
                [
                    ...
                    C__PROPERTY__DATA     => [
                        ...
                        C__PROPERTY__DATA__RELATION_TYPE    => C__RELATION_TYPE__DBMS,
            ...
            'listener'        => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'database_schema' => array_replace_recursive(
                isys_cmdb_dao_category_pattern::object_browser(),
                [
                    C__PROPERTY__INFO     => [
            ...
            'description'     => array_replace_recursive(
                ...
                [
                    ...
                    C__PROPERTY__UI   => [
                        C__PROPERTY__UI__ID => 'C__CMDB__CAT__COMMENTARY_' . C__CMDB__CATEGORY__TYPE_SPECIFIC . C__CATS__DATABASE_INSTANCE
                    ]
                ]
            )
        ];
    ...
    public function save($p_id, $p_title, $p_listener, $p_description, $p_dbms, $p_connected_schemas = "", $p_status = C__RECORD_STATUS__NORMAL)
    {
        ...
        $l_strSql = "UPDATE isys_cats_database_instance_list " . "SET " . "isys_cats_database_instance_list__isys_connection__id = " . $this->convert_sql_id(
                $this->handle_connection($p_id, $p_dbms)
            ) . ", " . "isys_cats_database_instance_list__title = " . $this->convert_sql_text(
                $p_title
            ) . ", " . "isys_cats_database_instance_list__listener = " . $this->convert_sql_text(
                $p_listener
            ) . ", " . "isys_cats_database_instance_list__description = " . $this->convert_sql_text(
                $p_description
    ...
    public function create($p_object_id, $p_title, $p_listener, $p_description, $p_dbms, $p_connected_schemas, $p_status = C__RECORD_STATUS__NORMAL)
    {
        ...
        $l_strSql = "INSERT IGNORE INTO isys_cats_database_instance_list SET " . "isys_cats_database_instance_list__isys_obj__id = " . $this->convert_sql_id(
                $p_object_id
            ) . ", " . "isys_cats_database_instance_list__isys_connection__id = " . $this->convert_sql_id(
                $l_connection->add_connection($p_dbms)
            ) . ", " . "isys_cats_database_instance_list__title = " . $this->convert_sql_text(
                $p_title
            ) . ", " . "isys_cats_database_instance_list__listener = " . $this->convert_sql_text(
                $p_listener
    ...
    public function get_connected_database_schema($p_obj_id, $p_instance_id)
    {
        ...
        $l_sql = "SELECT * FROM isys_cats_database_schema_list " . "INNER JOIN isys_connection ON isys_connection__id = isys_cats_database_schema_list__isys_connection__id " . "INNER JOIN isys_obj ON isys_obj__id = isys_cats_database_schema_list__isys_obj__id " . "WHERE isys_connection__isys_obj__id = " . $this->convert_sql_id(
                $p_obj_id
            ) . " " . "AND isys_cats_database_schema_list__isys_cats_db_instance_list__id = " . $this->convert_sql_id($p_instance_id);
    ...
    public function attach_connected_database_schema($p_schema_obj_id, $p_dbms_obj_id, $p_cat_id)
    {
        ...
        $l_update = "UPDATE isys_cats_database_schema_list " . "INNER JOIN isys_connection ON isys_connection__id = isys_cats_database_schema_list__isys_connection__id " . "SET isys_connection__isys_obj__id = " . $this->convert_sql_id(
                $p_dbms_obj_id
            ) . ", " . "isys_cats_database_schema_list__isys_cats_db_instance_list__id = " . $this->convert_sql_id(
                $p_cat_id
            ) . " " . "WHERE isys_cats_database_schema_list__isys_obj__id = " . $this->convert_sql_id($p_schema_obj_id);
    ...
    {
        $l_update = "UPDATE isys_cats_database_schema_list " . "INNER JOIN isys_connection ON isys_connection__id = isys_cats_database_schema_list__isys_connection__id " . "SET isys_connection__isys_obj__id = NULL, " . "isys_cats_database_schema_list__isys_cats_db_instance_list__id = NULL, " . "isys_cats_database_schema_list__isys_catg_relation_list__id = NULL " . "WHERE isys_cats_database_schema_list__isys_obj__id = " . $this->convert_sql_id(
                $p_schema_obj_id
            );
