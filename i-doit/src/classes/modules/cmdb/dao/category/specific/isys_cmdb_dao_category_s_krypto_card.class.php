...
class isys_cmdb_dao_category_s_krypto_card extends isys_cmdb_dao_category_specific
{
    ...
    {
        return [
            'certificate_number'    => array_replace_recursive(
            ...
            'certgate_card_number'  => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'certificate_title'     => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'certificate_password'  => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'certificate_procedure' => array_replace_recursive(
            ...
            'date_of_issue'         => array_replace_recursive(
                isys_cmdb_dao_category_pattern::date(),
                [
                    C__PROPERTY__INFO => [
            ...
            'description'           => array_replace_recursive(
                ...
                [
                    ...
                    C__PROPERTY__UI   => [
                        C__PROPERTY__UI__ID => 'C__CMDB__CAT__COMMENTARY_' . C__CMDB__CATEGORY__TYPE_SPECIFIC . C__CATS__KRYPTO_CARD
                    ]
                ]
            )
        ];
        ...
        if (is_array($p_category_data) && isset($p_category_data['properties']))
        {
            ...
            if ($p_status === isys_import_handler_cmdb::C__CREATE || $p_status === isys_import_handler_cmdb::C__UPDATE)
            {
                $l_indicator = $this->save(
                    ...
                    $p_category_data['properties']['certificate_number'][C__DATA__VALUE],
                    $p_category_data['properties']['certgate_card_number'][C__DATA__VALUE],
                    $p_category_data['properties']['certificate_title'][C__DATA__VALUE],
                    $p_category_data['properties']['certificate_password'][C__DATA__VALUE],
                    $p_category_data['properties']['certificate_procedure'][C__DATA__VALUE],
                    $p_category_data['properties']['date_of_issue'][C__DATA__VALUE],
                    $p_category_data['properties']['imei_number'][C__DATA__VALUE],
    ...
    public function save_element($p_cat_level, &$p_intOldRecStatus)
    {
        ...
        if (empty($l_list_id)) $l_list_id = $this->create_connector("isys_cats_krypto_card_list", $_GET[C__CMDB__GET__OBJECT]);

        $l_bRet = $this->save(
            $l_list_id,
            $p_intOldRecStatus,
            $_POST['C__CATS__KRYPTO_CARD__CERTIFICATE_NUMBER'],
            $_POST['C__CATS__KRYPTO_CARD__CERTGATE_CARD_NUMBER'],
            $_POST['C__CATS__KRYPTO_CARD__CERTIFICATE_TITLE'],
            $_POST['C__CATS__KRYPTO_CARD__CERTIFICATE_PASSWORD'],
            $_POST['C__CATS__KRYPTO_CARD__CERTIFICATE_PROCEDURE__HIDDEN'],
            $_POST['C__CATS__KRYPTO_CARD__DATE_OF_ISSUE__HIDDEN'],
            $_POST['C__CATS__KRYPTO_CARD__IMEI_NUMBER'],
            $_POST["C__CMDB__CAT__COMMENTARY_" . $this->get_category_type() . $this->get_category_id()],
            $_POST['C__CATS__KRYPTO_CARD__ASSIGNED_MOBILE_PHONE__HIDDEN']
        );
     ...
     * @return  boolean
     */
    public function save($p_cat_level, $p_newRecStatus = C__RECORD_STATUS__NORMAL, $p_certicate_number = null, $p_certgate_card_number = null, $p_certificate_title = null, $p_certificate_password = null, $p_certificate_procedure = null, $p_date_of_issue = null, $p_imei_number = null, $p_description = null, $p_mobile_phone = null)
    {
        $l_strSql = "UPDATE isys_cats_krypto_card_list SET
			...
			isys_cats_krypto_card_list__status = " . $this->convert_sql_id($p_newRecStatus) . "
     ...
     * @return  boolean
     */
    public function create($p_objID, $p_newRecStatus = C__RECORD_STATUS__NORMAL, $p_certicate_number = null, $p_certgate_card_number = null, $p_certificate_title = null, $p_certificate_password = null, $p_certificate_procedure = null, $p_date_of_issue = null, $p_imei_number = null, $p_description = null)
    {
