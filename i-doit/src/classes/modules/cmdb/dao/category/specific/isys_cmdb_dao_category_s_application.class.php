...
class isys_cmdb_dao_category_s_application extends isys_cmdb_dao_category_specific
{
    ...
    {
        return [
            C__APPLICATION__INSTALLATION_TYPE__AUTOMATIC => _L("LC__CMDB__CATS__APPLICATION_INSTALLATION_TYPE__AUTOMATIC"),
            C__APPLICATION__INSTALLATION_TYPE__MANUAL    => _L("LC__CMDB__CATS__APPLICATION_INSTALLATION_TYPE__MANUAL")
        ];
    } // function
    ...
    {
        return serialize(isys_cmdb_dao_category_s_application::get_installation_types());
    } // function
     ...
     */
    public function save($p_cat_level, $p_newRecStatus, $p_specification, $p_manufacturerID, $p_release, $p_description, $p_installation_type = null, $p_registration_key = null, $p_install_path = null)
    {
     ...
     * @author  Dennis Bluemer <dbluemer@i-doit.org>
     */
    public function create($p_objID, $p_newRecStatus, $p_specification, $p_manufacturerID, $p_release, $p_description, $p_installation_type = null, $p_registration_key = null, $p_install_path = null)
    {
    ...
    {
        if ($this->get_category_id() == C__CATS__APPLICATION)
        {
            $l_sql = 'SELECT
				(
        ...
        return [
            ...
            'manufacturer'     => array_replace_recursive(
                ...
                [
                    ...
                    C__PROPERTY__DATA     => [
                        C__PROPERTY__DATA__FIELD      => 'isys_cats_application_list__isys_application_manufacturer__id',
                    ...
                    C__PROPERTY__UI       => [
                        C__PROPERTY__UI__ID     => 'C__CATS__APPLICATION_MANUFACTURER_ID',
                        C__PROPERTY__UI__PARAMS => [
                            'p_strTable' => 'isys_application_manufacturer'
                        ]
                    ],
                    C__PROPERTY__PROVIDES => [
            ...
            'release'          => array_replace_recursive(
                ...
                [
                    C__PROPERTY__INFO => [
                        C__PROPERTY__INFO__TITLE       => 'LC__CMDB__CATS__APPLICATION_RELEASE',
                        C__PROPERTY__INFO__DESCRIPTION => 'Release'
                    ],
                    C__PROPERTY__DATA => [
                        C__PROPERTY__DATA__FIELD => 'isys_cats_application_list__release'
                    ],
                    C__PROPERTY__UI   => [
                        C__PROPERTY__UI__ID => 'C__CATS__APPLICATION_RELEASE'
                    ]
                ]
            ),
            'installation'     => array_replace_recursive(
                isys_cmdb_dao_category_pattern::dialog(),
                [
                    C__PROPERTY__INFO     => [
                        C__PROPERTY__INFO__TITLE       => 'LC__CMDB__CATS__APPLICATION_INSTALLATION_TYPE',
                        C__PROPERTY__INFO__DESCRIPTION => 'Installation'
                    ],
                    C__PROPERTY__DATA     => [
                        C__PROPERTY__DATA__FIELD      => 'isys_cats_application_list__isys_installation_type__id',
                        C__PROPERTY__DATA__REFERENCES => [
                            'isys_installation_type',
                            'isys_installation_type__id'
                        ]
                    ],
                    C__PROPERTY__UI       => [
                        C__PROPERTY__UI__ID     => 'C__CATS__APPLICATION_INSTALLATION_TYPE',
                        C__PROPERTY__UI__PARAMS => [
                            'p_strTable' => 'isys_installation_type'
                        ]
                    ],
                    C__PROPERTY__PROVIDES => [
                        C__PROPERTY__PROVIDES__SEARCH => false
            ...
            'registration_key' => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'install_path'     => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'description'      => array_replace_recursive(
                ...
                [
                    ...
                    C__PROPERTY__UI   => [
                        C__PROPERTY__UI__ID => 'C__CMDB__CAT__COMMENTARY_' . C__CMDB__CATEGORY__TYPE_SPECIFIC . C__CATS__APPLICATION
                    ]
                ]
            )
        ];
