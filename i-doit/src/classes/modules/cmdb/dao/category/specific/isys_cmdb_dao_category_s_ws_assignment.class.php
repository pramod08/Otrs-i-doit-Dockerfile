...
class isys_cmdb_dao_category_s_ws_assignment extends isys_cmdb_dao_category_specific implements ObjectBrowserReceiver
{
     ...
     */
    protected $m_category_const = 'C__CMDB__SUBCAT__WS_ASSIGNMENT';
    /**
     ...
     * @fixme  No standard behavior!
     */
    protected $m_category_id = C__CMDB__SUBCAT__WS_ASSIGNMENT;
    /**
     * @var string
     */
    ...
    public function get_assigned_objects($p_obj_id, $p_as_string = false)
    {
        ...
        $l_query = "SELECT * FROM " . "isys_cats_ws_net_type_list_2_isys_obj " . "INNER JOIN isys_obj ON isys_cats_ws_net_type_list_2_isys_obj.isys_obj__id = isys_obj.isys_obj__id " . "INNER JOIN isys_obj_type ON isys_obj_type__id = isys_obj__isys_obj_type__id " . "WHERE isys_cats_ws_net_type_list__id = " . $this->convert_sql_id(
                $l_catdata["isys_cats_ws_net_type_list__id"]
            );
    ...
    public function create($p_obj_id, $p_assigned_obj_id)
    {
        ...
        $l_insert = "INSERT INTO isys_cats_ws_net_type_list_2_isys_obj " . "SET isys_cats_ws_net_type_list__id = " . $this->convert_sql_id(
                $l_catdata["isys_cats_ws_net_type_list__id"]
            ) . ", " . "isys_obj__id = " . $this->convert_sql_id($p_assigned_obj_id) . ';';
    ...
    public function get_data($p_cats_list_id = null, $p_obj_id = null, $p_condition = "", $p_filter = null, $p_status = null)
    {
        ...
        $l_sql = "SELECT * FROM isys_cats_ws_net_type_list_2_isys_obj tb1 " . "INNER JOIN isys_cats_ws_net_type_list tb2 ON tb2.isys_cats_ws_net_type_list__id = tb1.isys_cats_ws_net_type_list__id " . "INNER JOIN isys_obj tb3 ON tb3.isys_obj__id = tb1.isys_obj__id " . "WHERE TRUE " . $p_condition;
