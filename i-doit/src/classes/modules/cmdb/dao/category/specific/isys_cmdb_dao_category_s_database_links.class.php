...
class isys_cmdb_dao_category_s_database_links extends isys_cmdb_dao_category_specific
{
    ...
    public function get_data($p_cats_list_id = null, $p_obj_id = null, $p_condition = "", $p_filter = null, $p_status = null)
    {
        ...
        $l_sql = "SELECT " . "db_schema.isys_obj__title as schema_title, " . "link.*, " . "isys_cats_database_links_list.*, " . "isys_connection.* " . "FROM isys_cats_database_links_list " . "INNER JOIN isys_obj link " . "ON " . "link.isys_obj__id = " . "isys_cats_database_links_list__isys_obj__id " . "LEFT OUTER JOIN isys_connection " . "ON " . "isys_connection__id = " . "isys_cats_database_links_list__isys_connection__id " . "LEFT OUTER JOIN isys_obj db_schema " . "ON " . "isys_connection__isys_obj__id = " . "db_schema.isys_obj__id " . "WHERE TRUE ";
    ...
    protected function properties()
    {
        return [
            ...
            'link'        => array_replace_recursive(
                ...
                [
                    ...
                    C__PROPERTY__DATA     => [
                        ...
                        C__PROPERTY__DATA__RELATION_TYPE    => C__RELATION_TYPE__DATABASE_LINK,
            ...
            'target_user' => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'public'      => array_replace_recursive(
            ...
            'description' => array_replace_recursive(
                ...
                [
                    ...
                    C__PROPERTY__UI   => [
                        C__PROPERTY__UI__ID => 'C__CMDB__CAT__COMMENTARY_' . C__CMDB__CATEGORY__TYPE_SPECIFIC . C__CATS__DATABASE_LINKS
                    ]
                ]
            )
        ];
        ...
        if (is_array($p_category_data) && isset($p_category_data['properties']))
        {
            if ($p_status === isys_import_handler_cmdb::C__CREATE)
            {
                if ($p_category_data['data_id'] = $this->create(
                    ...
                    $p_category_data['properties']['target_user'][C__DATA__VALUE],
                    $p_category_data['properties']['owner'][C__DATA__VALUE],
                    $p_category_data['properties']['public'][C__DATA__VALUE],
    ...
    public function save_element($p_cat_level, &$p_status, $p_create = false)
    {
        ...
        $l_bRet = $this->save(
            $l_list_id,
            $_POST["C__CMDB__CATS__DATABASE_LINKS__SCHEMA__HIDDEN"],
            $_POST["C__CMDB__CATS__DATABASE_LINKS__TITLE"],
            $_POST["C__CMDB__CATS__DATABASE_LINKS__TARGET_USER"],
            $_POST["C__CMDB__CATS__DATABASE_LINKS__OWNER"],
            $_POST["C__CMDB__CATS__DATABASE_LINKS__PUBLIC"],
    ...
    public function save($p_id, $p_schema_object, $p_title, $p_target_user, $p_owner, $p_public, $p_description, $p_status = C__RECORD_STATUS__NORMAL)
    {
        ...
        if (!$p_public) $p_public = 0;

        $l_strSql = "UPDATE isys_cats_database_links_list " . "SET " . "isys_cats_database_links_list__isys_connection__id = " . $this->convert_sql_id(
                $this->handle_connection($p_id, $p_schema_object)
            ) . ", " . "isys_cats_database_links_list__title = " . $this->convert_sql_text(
                $p_title
            ) . ", " . "isys_cats_database_links_list__target_user = " . $this->convert_sql_text(
                $p_target_user
            ) . ", " . "isys_cats_database_links_list__owner = " . $this->convert_sql_text(
                $p_owner
            ) . ", " . "isys_cats_database_links_list__public = " . $this->convert_sql_int(
                $p_public
            ) . ", " . "isys_cats_database_links_list__description = " . $this->convert_sql_text(
                $p_description
            ) . ", " . "isys_cats_database_links_list__status = " . $this->convert_sql_id($p_status) . " " .
        ...
        if ($this->update($l_strSql) && $this->apply_update())
        {
            ...
            $l_relation_dao->handle_relation(
                ...
                C__RELATION_TYPE__DATABASE_LINK,
                $l_data["isys_cats_database_links_list__isys_catg_relation_list__id"],
                $p_schema_object,
                $l_data["isys_cats_database_links_list__isys_obj__id"]
            );
    ...
    public function create($p_object_id, $p_schema_object, $p_title, $p_target_user, $p_owner, $p_public, $p_description, $p_status = C__RECORD_STATUS__NORMAL)
    {
        ...
        $l_strSql = "INSERT INTO isys_cats_database_links_list SET " . "isys_cats_database_links_list__isys_obj__id = " . $this->convert_sql_id(
                $p_object_id
            ) . ", " . "isys_cats_database_links_list__isys_connection__id = " . $this->convert_sql_id(
                $l_dao_connection->add_connection($p_schema_object)
            ) . ", " . "isys_cats_database_links_list__title = " . $this->convert_sql_text(
                $p_title
            ) . ", " . "isys_cats_database_links_list__target_user = " . $this->convert_sql_text(
                $p_target_user
                ...
                $p_owner
            ) . ", " . "isys_cats_database_links_list__public = " . $this->convert_sql_id(
                $p_public
            ) . ", " . "isys_cats_database_links_list__description = " . $this->convert_sql_text(
                $p_description
            ) . ", " . "isys_cats_database_links_list__status = " . $this->convert_sql_id($p_status) . ";";
        ...
        if ($this->update($l_strSql) && $this->apply_update())
        {
            ...
            if (!is_null($p_schema_object) && $p_schema_object > 0)
            {
                 ...
                 */
                $l_relation_dao = new isys_cmdb_dao_category_g_relation($this->get_database_component());
                $l_relation_dao->handle_relation($l_last_id, "isys_cats_database_links_list", C__RELATION_TYPE__DATABASE_LINK, null, $p_schema_object, $p_object_id);
            }
