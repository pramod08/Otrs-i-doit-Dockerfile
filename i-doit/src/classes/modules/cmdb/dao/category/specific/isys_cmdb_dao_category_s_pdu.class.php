...
class isys_cmdb_dao_category_s_pdu extends isys_cmdb_dao_category_specific
{
        ...
        return [
            ...
            'description' => array_replace_recursive(
                ...
                [
                    ...
                    C__PROPERTY__UI   => [
                        C__PROPERTY__UI__ID => 'C__CMDB__CAT__COMMENTARY_' . C__CMDB__CATEGORY__TYPE_SPECIFIC . C__CATS__PDU
                    ]
                ]
            )
        ];
        ...
        if (is_array($p_category_data) && isset($p_category_data['properties']))
        {
            ...
            if ($p_status === isys_import_handler_cmdb::C__CREATE || $p_status === isys_import_handler_cmdb::C__UPDATE)
            {
                ...
                $l_indicator = $this->save(
                    ...
                    $p_category_data['properties']['pdu_id'][C__DATA__VALUE],
    ...
    public function save_element($p_cat_level, &$p_status, $p_create = false)
    {
        ...
        $l_bRet = $this->save(
            $l_list_id,
            $_POST["C__CMDB__CATS__PDU__PDU_ID"],
