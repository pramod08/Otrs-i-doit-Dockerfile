...
class isys_cmdb_dao_category_g_voip_phone extends isys_cmdb_dao_category_global
{
    ...
    {
        return [
            'device_protocol'               => array_replace_recursive(
            ...
            'device_pool'                   => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'common_configuration'          => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'button_template'               => array_replace_recursive(
                isys_cmdb_dao_category_pattern::dialog_plus(),
                [
                    C__PROPERTY__INFO   => [
                        C__PROPERTY__INFO__TITLE       => 'LC__CMDB__CATG__VOIP_PHONE__BUTTON_TEMPLATE',
                        C__PROPERTY__INFO__DESCRIPTION => 'Button template'
                    ],
                    C__PROPERTY__DATA   => [
                        C__PROPERTY__DATA__FIELD      => 'isys_catg_voip_phone_list__isys_voip_phone_button_template__id',
                        C__PROPERTY__DATA__REFERENCES => [
                            'isys_voip_phone_button_template',
                            'isys_voip_phone_button_template__id'
                        ]
                    ],
                    C__PROPERTY__UI     => [
                        C__PROPERTY__UI__ID     => 'C__CMDB__CATG__VOIP_PHONE__BUTTON_TEMPLATE',
                        C__PROPERTY__UI__PARAMS => [
                            'p_strTable' => 'isys_voip_phone_button_template'
                        ]
                    ],
                    C__PROPERTY__FORMAT => [
            ...
            'softkey_template'              => array_replace_recursive(
                isys_cmdb_dao_category_pattern::dialog_plus(),
                [
                    C__PROPERTY__INFO   => [
                        C__PROPERTY__INFO__TITLE       => 'LC__CMDB__CATG__VOIP_PHONE__SOFTKEY_TEMPLATE',
                        C__PROPERTY__INFO__DESCRIPTION => 'Softkey template'
                    ],
                    C__PROPERTY__DATA   => [
                        C__PROPERTY__DATA__FIELD      => 'isys_catg_voip_phone_list__isys_voip_phone_softkey_template__id',
                        C__PROPERTY__DATA__REFERENCES => [
                            'isys_voip_phone_softkey_template',
                            'isys_voip_phone_softkey_template__id'
                        ]
                    ],
                    C__PROPERTY__UI     => [
                        C__PROPERTY__UI__ID     => 'C__CMDB__CATG__VOIP_PHONE__SOFTKEY_TEMPLATE',
                        C__PROPERTY__UI__PARAMS => [
                            'p_strTable' => 'isys_voip_phone_softkey_template'
                        ]
                    ],
                    C__PROPERTY__FORMAT => [
                        C__PROPERTY__FORMAT__CALLBACK => [
            ...
            'common_profile'                => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'aar_calling_search_space'      => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'media_resource_group_list'     => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'aar_group'                     => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'user_locale'                   => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'network_locale'                => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'built_in_bridge'               => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'device_mobility_mode'          => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'owner_user_id'                 => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'phone_suite'                   => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'services_provisioning'         => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'load_name'                     => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'description'                   => array_replace_recursive(
                ...
                [
                    ...
                    C__PROPERTY__UI   => [
                        C__PROPERTY__UI__ID => 'C__CMDB__CAT__COMMENTARY_' . C__CMDB__CATEGORY__TYPE_GLOBAL . C__CATG__VOIP_PHONE
                    ]
                ]
            )
        ];
