...
class isys_cmdb_dao_category_g_tsi_service extends isys_cmdb_dao_category_global
{
    ...
    public function get_data($p_catg_list_id = null, $p_obj_id = null, $p_condition = "", $p_filter = null, $p_status = null)
    {
        ...
        $l_sql = "SELECT * FROM isys_catg_tsi_service_list " . "INNER JOIN isys_obj " . "ON " . "isys_catg_tsi_service_list__isys_obj__id = " . "isys_obj__id " . "WHERE TRUE ";
    ...
    {
        return [
            'tsi_service_id' => array_replace_recursive(
            ...
            'description'    => array_replace_recursive(
                ...
                [
                    ...
                    C__PROPERTY__UI   => [
                        C__PROPERTY__UI__ID => 'C__CMDB__CAT__COMMENTARY_' . C__CMDB__CATEGORY__TYPE_GLOBAL . C__CATG__TSI_SERVICE,
                    ]
                ]
            )
        ];
        ...
        if (is_array($p_category_data) && isset($p_category_data['properties']))
        {
            ...
            if ($p_status === isys_import_handler_cmdb::C__CREATE || $p_status === isys_import_handler_cmdb::C__UPDATE)
            {
                ...
                $l_indicator = $this->save(
                    ...
                    $p_category_data['properties']['tsi_service_id'][C__DATA__VALUE],
    ...
    public function save_element($p_cat_level, &$p_intOldRecStatus)
    {
        ...
        if (empty($l_id)) $l_id = $this->create($_GET[C__CMDB__GET__OBJECT], null, null);

        $l_bRet = $this->save(
            $l_id,
            $_POST["C__CATG__TSI_SERVICE__TSI_SERVICE_ID"],
    ...
    public function save($p_cat_level, $p_tsi_service_id = null, $p_description = null, $p_status = C__RECORD_STATUS__NORMAL)
    {
        ...
        $l_strSql = "UPDATE isys_catg_tsi_service_list SET " . "isys_catg_tsi_service_list__description = " . $this->convert_sql_text(
                $p_description
            ) . ", " . "isys_catg_tsi_service_list__tsi_service_id = " . $this->convert_sql_text(
                $p_tsi_service_id
            ) . ", " . "isys_catg_tsi_service_list__status = " . $this->convert_sql_int($p_status) . " " . "WHERE isys_catg_tsi_service_list__id = " . $this->convert_sql_id(
                $p_cat_level
            );
    ...
    {
        $l_strSql = "INSERT IGNORE INTO isys_catg_tsi_service_list SET " . "isys_catg_tsi_service_list__description = " . $this->convert_sql_text(
                $p_description
            ) . ", " . "isys_catg_tsi_service_list__tsi_service_id = " . $this->convert_sql_text(
                $p_tsi_service_id
            ) . ", " . "isys_catg_tsi_service_list__status = " . C__RECORD_STATUS__NORMAL . ", " . "isys_catg_tsi_service_list__isys_obj__id = " . $this->convert_sql_id(
                $p_objID
            ) . ";";
