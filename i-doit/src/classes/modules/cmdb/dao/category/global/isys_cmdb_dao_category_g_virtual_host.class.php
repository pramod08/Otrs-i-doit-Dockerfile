...
class isys_cmdb_dao_category_g_virtual_host extends isys_cmdb_dao_category_global
{
     ...
     */
    public function create($p_object_id, $p_status = C__RECORD_STATUS__NORMAL, $p_virtual_host = null, $p_license_server = null, $p_administration_service = null, $p_description = '')
    {
        $l_dao_con = new isys_cmdb_dao_connection(isys_application::instance()->database);

        $l_sql = "INSERT IGNORE INTO isys_catg_virtual_host_list " . "SET " . "isys_catg_virtual_host_list__status = '" . $p_status . "', " . "isys_catg_virtual_host_list__virtual_host = '" . $p_virtual_host . "', " . "isys_catg_virtual_host_list__description = " . $this->convert_sql_text(
                $p_description
            ) . ", " . "isys_catg_virtual_host_list__isys_obj__id = '" . $p_object_id . "', " . "isys_catg_virtual_host_list__license_server = " . $this->convert_sql_id(
                $l_dao_con->add_connection($p_license_server)
            ) . ", " . "isys_catg_virtual_host_list__administration_service = " . $this->convert_sql_id(
                $l_dao_con->add_connection($p_administration_service)
            ) . ";";
        ...
        if ($this->update($l_sql))
        {
            ...
            isys_cmdb_dao_category_g_relation::instance($this->m_db)
                ->handle_relation(
                    ...
                    C__RELATION_TYPE__VHOST_ADMIN_SERVICE,
                    null,
                    $p_administration_service,
                    $p_object_id
                );
    ...
    public function save($p_id, $p_status = C__RECORD_STATUS__NORMAL, $p_virtual_host = null, $p_license_server = null, $p_administration_service = null, $p_description = '')
    {
        ...
        if (is_numeric($p_id))
        {
            ...
            $l_sql = "UPDATE isys_catg_virtual_host_list " . "SET " . "isys_catg_virtual_host_list__status = '" . $p_status . "', " . "isys_catg_virtual_host_list__virtual_host = '" . $p_virtual_host . "', " . "isys_catg_virtual_host_list__description = " . $this->convert_sql_text(
                    $p_description
                ) . ", " . "isys_catg_virtual_host_list__license_server = '" . $l_licence_server . "', " . "isys_catg_virtual_host_list__administration_service = '" . $l_administration_service . "' " . "WHERE " . "(isys_catg_virtual_host_list__id = '" . $p_id . "')" . ";";
            ...
            if ($this->update($l_sql))
            {
                ...
                isys_cmdb_dao_category_g_relation::instance($this->m_db)
                    ->handle_relation(
                        ...
                        "isys_catg_virtual_host_list",
                        C__RELATION_TYPE__VHOST_ADMIN_SERVICE,
                        $l_data['isys_catg_virtual_host_list__isys_catg_relation_list__id'],
                        $p_administration_service,
                        $l_data['isys_catg_virtual_host_list__isys_obj__id']
                    );
    ...
    public function save_element(&$p_cat_level, &$p_status, $p_create = false)
    {
        ...
        else
        {
             ...
             */
            if ($this->save(
                $l_catdata["isys_catg_virtual_host_list__id"],
    ...
    {
        if ($this->get_category_id() == C__CATG__VIRTUAL_HOST_ROOT)
        {
            $l_sql = 'SELECT
				(
            ...
            'administration_service' => array_replace_recursive(
                ...
                [
                    ...
                    C__PROPERTY__DATA     => [
                        ...
                        C__PROPERTY__DATA__RELATION_TYPE    => C__RELATION_TYPE__VHOST_ADMIN_SERVICE,
