...
class isys_cmdb_dao_category_g_cluster_memberships extends isys_cmdb_dao_category_global implements ObjectBrowserReceiver
{
    ...
    public function attachObjects($p_object_id, array $p_objects)
    {
        ...
        if (is_array($l_assigned_clusters_as_array)) $l_assigned_clusters = array_flip($l_assigned_clusters_as_array);
    ...
    public function create($p_objID, $p_newRecStatus, $p_connectedObjID, $p_description = null)
    {
        ...
        if ($this->update($l_strSql) && $this->apply_update())
        {
            ...
            $l_relation_dao->handle_relation($l_last_id, "isys_catg_cluster_members_list", C__RELATION_TYPE__CLUSTER_MEMBERSHIPS, null, $p_connectedObjID, $p_objID);
    ...
    public function get_assigned_clusters($p_obj_id)
    {
        ...
        return $l_dao_cluster_members->get_data(
            null,
            null,
    ...
    {
        $l_sql = "SELECT isys_catg_cluster_members_list__isys_obj__id, isys_catg_cluster_members_list__id " . "FROM isys_catg_cluster_members_list " . "LEFT JOIN isys_connection ON isys_connection__id = isys_catg_cluster_members_list__isys_connection__id " . "WHERE isys_connection__isys_obj__id = " . $this->convert_sql_id(
                $p_obj_id
            );
    ...
    public function get_count($p_obj_id = null)
    {
        ...
        $l_sql = "SELECT COUNT(isys_obj__id) AS count FROM isys_catg_cluster_members_list " . "INNER JOIN isys_connection ON isys_connection__id = isys_catg_cluster_members_list__isys_connection__id " . "INNER JOIN isys_obj ON isys_obj__id = isys_catg_cluster_members_list__isys_obj__id " . "WHERE TRUE ";
        ...
        $l_sql .= " AND (isys_catg_cluster_members_list__status = " . $this->convert_sql_int(
                C__RECORD_STATUS__NORMAL
    ...
    public function get_data($p_catg_list_id = null, $p_obj_id = null, $p_condition = "", $p_filter = null, $p_status = null)
    {
        ...
        $l_sql = "SELECT * FROM isys_catg_cluster_members_list " . "INNER JOIN isys_connection ON isys_connection__id = isys_catg_cluster_members_list__isys_connection__id " . "INNER JOIN isys_obj ON isys_obj__id = isys_catg_cluster_members_list__isys_obj__id " . "WHERE TRUE " . $p_condition . " ";
        ...
        if (is_array($p_category_data) && isset($p_category_data['properties']))
        {
            switch ($p_status)
            {
                ...
                case isys_import_handler_cmdb::C__UPDATE:
                    ...
                    if ($p_category_data['data_id'] > 0) return $p_category_data['data_id'];
