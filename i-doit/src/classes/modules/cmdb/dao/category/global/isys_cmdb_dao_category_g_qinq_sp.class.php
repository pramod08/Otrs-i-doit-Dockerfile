...
class isys_cmdb_dao_category_g_qinq_sp extends isys_cmdb_dao_category_global
{
    ...
    public function save(&$p_category_id, $p_status = C__RECORD_STATUS__NORMAL, $p_spvlan, $p_object_id = null, $p_relation_id = null, $p_description = null)
    {
        ...
        if ($this->update($l_sql) && $this->apply_update())
        {
            ...
            $l_relation_dao->handle_relation(
                $p_category_id,
                $this->m_table,
                C__RELATION_TYPE__LAYER2_TRANSPORT,
                $l_old_data["isys_catg_qinq_list__isys_catg_relation_list__id"],
                $p_spvlan,
                $l_old_data["isys_catg_qinq_list__isys_obj__id"]
            );
        } // if
    ...
    {
        return [
            'spvlan'      => array_replace_recursive(
                ...
                [
                    ...
                    C__PROPERTY__DATA     => [
                        ...
                        C__PROPERTY__DATA__RELATION_TYPE    => C__RELATION_TYPE__LAYER2_TRANSPORT,
            ...
            'description' => array_replace_recursive(
                ...
                [
                    ...
                    C__PROPERTY__UI   => [
                        C__PROPERTY__UI__ID => 'C__CMDB__CAT__COMMENTARY_' . C__CMDB__CATEGORY__TYPE_GLOBAL . C__CATG__QINQ_SP
                    ]
                ]
            )
        ];
        ...
        if (is_array($p_category_data) && isset($p_category_data['properties']))
        {
            ...
            if (($p_status == isys_import_handler_cmdb::C__CREATE || $p_status == isys_import_handler_cmdb::C__UPDATE) && $p_category_data['data_id'] > 0)
            {
                $this->save(
                    ...
                    C__RECORD_STATUS__NORMAL,
                    $p_category_data['properties']['spvlan'][C__DATA__VALUE],
                    null,
                    null,
