...
class isys_cmdb_dao_category_g_rm_controller extends isys_cmdb_dao_category_global
{
    ...
    public function dynamic_property_callback_remote_url($p_row)
    {
        ...
        if ($l_res->num_rows() > 0)
        {
            ...
            return $l_dao->format_url($l_data['isys_catg_access_list__url'], $p_row['isys_obj__id']);
        }
        else
        {
            return null;
    ...
    public function save_element(&$p_cat_level, &$p_intOldRecStatus)
    {
        ...
        if (empty($l_list_id))
        {
            $l_id = $this->create(
                ...
                $l_status,
                $_POST['C__CATG__RM_CONTROLLER__ASSIGNED_OBJECT__HIDDEN'],
        ...
        {
            if ($this->save(
                $l_catdata['isys_catg_rm_controller_list__id'],
                $l_status,
                $_POST['C__CATG__RM_CONTROLLER__ASSIGNED_OBJECT__HIDDEN'],
                $_POST["C__CMDB__CAT__COMMENTARY_" . $this->get_category_type() . $this->get_category_id()]
            )
    ...
    public function create($p_object_id, $p_status = C__RECORD_STATUS__NORMAL, $p_assigned_object = null, $p_description = '')
    {
        ...
        if ($this->update($l_sql) && $this->apply_update())
        {
            ...
            $l_relation_dao->handle_relation(
                ...
                C__RELATION_TYPE__RM_CONTROLLER,
                null,
                $p_object_id,
                $p_assigned_object
            );
    ...
    public function save($p_cat_level, $p_status = C__RECORD_STATUS__NORMAL, $p_assigned_object = null, $p_description = '')
    {
        ...
        if ($this->update($l_sql) && $this->apply_update())
        {
            ...
            $l_relation_dao->handle_relation(
                ...
                "isys_catg_rm_controller_list",
                C__RELATION_TYPE__RM_CONTROLLER,
                $l_data["isys_catg_rm_controller_list__isys_catg_relation_list__id"],
                $l_data["isys_catg_rm_controller_list__isys_obj__id"],
                $p_assigned_object
            );
        ...
        return [
            ...
            '_remote_url'       => [
                ...
                C__PROPERTY__FORMAT   => [
                    C__PROPERTY__FORMAT__CALLBACK => [
                        $this,
                        'dynamic_property_callback_remote_url'
                    ]
                ],
                C__PROPERTY__PROVIDES => [
                    C__PROPERTY__PROVIDES__LIST       => true,
        ...
        return [
            'connected_object' => array_replace_recursive(
                ...
                [
                    ...
                    C__PROPERTY__DATA     => [
                        ...
                        C__PROPERTY__DATA__RELATION_TYPE    => C__RELATION_TYPE__RM_CONTROLLER,
            ...
            'description'      => array_replace_recursive(
                ...
                [
                    ...
                    C__PROPERTY__UI       => [
                        C__PROPERTY__UI__ID => 'C__CMDB__CAT__COMMENTARY_' . C__CMDB__CATEGORY__TYPE_GLOBAL . C__CATG__RM_CONTROLLER
                    ],
                    C__PROPERTY__PROVIDES => [
                        C__PROPERTY__PROVIDES__REPORT => false,
                        C__PROPERTY__PROVIDES__LIST   => false
