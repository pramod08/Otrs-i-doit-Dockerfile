            ...
            else
            {
                ...
                else
                {
                    isys_component_template_infobox::instance()
                        ->set_message('Error: Attaching own object is prohibitted.', 1, null, null, C__LOGBOOK__ALERT_LEVEL__3);
                }
            }
        }
    ...
    public function __construct(isys_component_database $p_db)
    {
        isys_component_signalcollection::get_instance()
            ->connect(
                ...
                [
                    'isys_cmdb_dao_category_g_virtual_object',
                    'validate_after_save'
                ]
            );
        isys_component_signalcollection::get_instance()
