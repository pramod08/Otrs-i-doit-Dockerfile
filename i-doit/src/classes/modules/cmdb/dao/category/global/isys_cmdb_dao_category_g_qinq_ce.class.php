...
class isys_cmdb_dao_category_g_qinq_ce extends isys_cmdb_dao_category_global implements ObjectBrowserReceiver
{
    ...
    {
        $l_dao          = new isys_cmdb_dao_category_g_qinq_sp($this->m_db);
        $l_relation_dao = new isys_cmdb_dao_relation($this->m_db);
    ...
    public function get_count($p_obj_id = null)
    {
        ...
        $l_sql = "SELECT COUNT(isys_catg_qinq_list__id) AS count FROM isys_catg_qinq_list " . "INNER JOIN isys_connection ON isys_connection__id = isys_catg_qinq_list__isys_connection__id " . "WHERE TRUE ";
