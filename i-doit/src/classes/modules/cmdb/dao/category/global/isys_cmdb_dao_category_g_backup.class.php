...
class isys_cmdb_dao_category_g_backup extends isys_cmdb_dao_category_global
{
    ...
    public function properties()
    {
        return [
            ...
            'backup'       => array_replace_recursive(
                ...
                [
                    ...
                    C__PROPERTY__DATA     => [
                        ...
                        C__PROPERTY__DATA__RELATION_TYPE    => C__RELATION_TYPE__BACKUP,
            ...
            'backup_type'  => array_replace_recursive(
            ...
            'path_to_save' => array_replace_recursive(
                isys_cmdb_dao_category_pattern::text(),
                [
                    C__PROPERTY__INFO => [
            ...
            'description'  => array_replace_recursive(
                ...
                [
                    ...
                    C__PROPERTY__UI   => [
                        C__PROPERTY__UI__ID => 'C__CMDB__CAT__COMMENTARY_' . C__CMDB__CATEGORY__TYPE_GLOBAL . C__CATG__BACKUP
                    ]
                ]
            )
        ];
                ...
                case isys_import_handler_cmdb::C__CREATE:
                    if ($p_object_id > 0)
                    {
                        return $this->create(
                            ...
                            $p_category_data['properties']['backup_type'][C__DATA__VALUE],
                            $p_category_data['properties']['cycle'][C__DATA__VALUE],
    ...
    public function save($p_cat_level, $p_newRecStatus = C__RECORD_STATUS__NORMAL, $p_title = null, $p_connectedObjID = null, $p_description = '', $p_backup_type = null, $p_backup_cycle = null, $p_path_to_save = null)
    {
        ...
        $l_strSql = "UPDATE isys_catg_backup_list
			SET
        ...
        if ($this->update($l_strSql))
        {
            if ($this->apply_update())
            {
                ...
                $l_relation_dao->handle_relation(
                    ...
                    $p_connectedObjID,
                    $l_data["isys_catg_backup_list__isys_obj__id"]
                );
    ...
    public function create($p_objID, $p_newRecStatus = C__RECORD_STATUS__NORMAL, $p_title = null, $p_connectedObjID = null, $p_description = '', $p_backup_type = null, $p_backup_cycle = null, $p_path_to_save = null)
    {
        ...
        $l_strSql = "INSERT INTO isys_catg_backup_list SET " . "isys_catg_backup_list__title = " . $this->convert_sql_text(
                ...
                $l_connection->add_connection($p_connectedObjID)
            ) . ", " . "isys_catg_backup_list__description = " . $this->convert_sql_text(
                $p_description
            ) . ", " . "isys_catg_backup_list__status = " . $this->convert_sql_id(
                $p_newRecStatus
