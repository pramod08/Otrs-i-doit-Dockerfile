...
class isys_cmdb_view_list_category extends isys_cmdb_view_list
{
    ...
    public function get_optional_parameters(&$l_gets)
    {
        ...
        $l_gets[C__CMDB__GET__NETPORT]    = true;
    ...
    public function handle_navmode($p_navmode)
    {
        ...
        $l_dao_lock  = new isys_component_dao_lock($g_comp_database);
        ...
        isys_auth_cmdb::instance()
            ->check(isys_auth::VIEW, 'OBJ_ID/' . $l_object_id);
        ...
        switch ($p_navmode)
        {
            ...
            case C__NAVMODE__NEW:
                    ...
                    throw new isys_exception_auth(
                        _L(
                            ...
                            [
                                ...
                                _L($l_dao_cmdb->get_catg_name_by_id_as_string($this->m_cat_dao->get_category_id()))
                            ]
                        )
                    );
                } // if
                ...
                $l_actionproc->insert(
                    C__CMDB__ACTION__CATEGORY_CREATE,
                    [
                        &$this->m_cat_dao,
                        &$this->m_cat_ui
                    ]
            ...
            case C__NAVMODE__RECYCLE:
                ...
                $l_actionproc->insert(
                    C__CMDB__ACTION__CATEGORY_RANK,
                    [
    ...
    public function list_init()
    {
        ...
        if (isset($l_gets[C__CMDB__GET__CATG]))
        {
            ...
            if ($l_gets[C__CMDB__GET__CATG] == C__CATG__CUSTOM_FIELDS)
            {
    ...
    public function list_process()
    {
        ...
        if ($this->m_cat_type !== null && $this->m_cat_const !== null)
        {
            ...
            // Rights-Check.
            isys_auth_cmdb::instance()
                ->check_rights_obj_and_category(isys_auth::VIEW, $l_gets[C__CMDB__GET__OBJECT], $l_catentry['isysgui_catg__const']);
            ...
            $l_objectTitle                           = $l_dao_cmdb->get_obj_name_by_id_as_string($l_gets[C__CMDB__GET__OBJECT]);
            $l_rules                                 = [];
            $l_rules["C__CATG__TITLE"]["p_strValue"] = stripslashes(isys_glob_htmlentities($l_objectTitle, null));
            $l_tpl->smarty_tom_add_rules("tom.content.top", $l_rules);
        }
        else
        {
            throw new isys_exception_cmdb(
                "Could not resolve category type and constant (current: " . var_export($this->m_cat_type, true) . "/" . var_export($this->m_cat_const, true) . ")!",
