...
<div id="widget-popup">
	...
	[{isys type="f_text" id="widget-popup-config-changed" p_bInfoIconSpacer=0 p_bInvisible=true p_strValue=0}]
	[{isys type="f_text" id="widget-popup-config-hidden" p_bInfoIconSpacer=0 p_bInvisible=true}]
...
<script type="text/javascript">
	(function() {
		...
		$popup_content.setStyle({height: ($popup.getHeight() - ($popup.down('.popup-header').getHeight() + $popup.down('.popup-footer').getHeight())) + 'px'});
	})();
