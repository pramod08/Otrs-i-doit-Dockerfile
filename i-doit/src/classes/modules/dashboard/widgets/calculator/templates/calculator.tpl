<h3 class="gradient p5 text-shadow border-bottom border-ccc">[{isys type="f_label" ident="LC__WIDGET__CALCULATOR"}]</h3>
...
<table class="m5">
	<tr>
		...
		<td><div id="[{$unique_id}]_calculator-messages" class="ml5 p5 error" style="display:none;"></div></td>
	</tr>
</table>
