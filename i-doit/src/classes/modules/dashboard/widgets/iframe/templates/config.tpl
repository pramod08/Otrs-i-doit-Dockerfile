<table class="contentTable">
	...
	<tr>
		...
		<td class="value">
			[{isys type="f_text" id="widget-popup-config-url" name="widget-popup-config-url" p_strPlaceholder="http://www.i-doit.com/" p_strStyle="width:80%;" p_strValue=$rules.url p_onChange="on_value_change();"}]
		</td>
	</tr>
	<tr>
		<td class="key">
		...
		<td class="value">
			[{isys type="f_count" id="widget-popup-config-height" name="widget-popup-config-height" p_strValue=$rules.height p_onChange="on_value_change();"}]
		</td>
	</tr>
</table>
