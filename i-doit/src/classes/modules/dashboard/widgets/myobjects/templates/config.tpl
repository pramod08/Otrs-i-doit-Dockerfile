<table class="contentTable">
	<tr>
		...
		<td class="value">[{isys type="f_count" id="widget-popup-config-count" name="widget-popup-config-count" p_strValue=$rules.count p_onChange="idoit.callbackManager.triggerCallback('widget-popup-config-count-change');"}]</td>
	</tr>
</table>
