<h3 class="p5 border-bottom border-ccc gradient text-shadow">[{isys type="lang" ident="LC__WIDGET__LOGGED_IN_USERS"}]</h3>
<div class="p5" style="overflow-x:auto;">
    ...
    <table cellspacing="0" cellpadding="2" class="" style="margin:0;text-align: left;width:100%;line-height:18px;">
        ...
        <tr style="line-height:20px;">
            <th class="border-bottom border-ccc" style="width:50%">[{isys type="lang" ident="LC__CATG__CONTACT_IDOIT_USER"}]</th>
            <th class="border-bottom border-ccc" style="width:50%">[{isys type="lang" ident="LC__WIDGET__LOGGED_IN_USERS__LAST_ACTION"}]</th>
        </tr>
        </thead>
