<table class="contentTable" id="config_[{$unique_id}]">
	<tr>
		...
		<td class="value">[{isys type="f_text" id="widget-popup-config-title" name="widget-popup-config-title" p_strValue=$rules.title p_strClass="normal"}]</td>
	</tr>
	<tr>
		<td class="key">[{isys type="f_label" name="widget-popup-config-color" ident="LC__WIDGET__NOTES__CONFIG__COLOR"}]</td>
		<td class="value">[{isys type="f_text" id="widget-popup-config-color" name="widget-popup-config-color" p_strValue=$rules.color p_strClass="normal"}]</td>
	</tr>
	<tr>
		<td class="key">[{isys type="f_label" name="widget-popup-config-fontcolor" ident="LC__WIDGET__NOTES__CONFIG__FONTCOLOR"}]</td>
		<td class="value">[{isys type="f_text" id="widget-popup-config-fontcolor" name="widget-popup-config-fontcolor" p_strValue=$rules.fontcolor p_strClass="normal"}]</td>
	</tr>
	<tr>
