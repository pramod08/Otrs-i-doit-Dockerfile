<div class="p10" id="report_view_import_types">
	<table class="contentTable">
		<tr>
			...
			<td class="value">[{isys type="f_dialog" name="C__IMPORT_TYPES" p_bEditMode="1" p_bDbFieldNN="1"}]</td>
		</tr>
		<tr>
			<td class="key">[{isys type='f_label' name='C__IMPORT_TYPES__TIMEPERIOD'  ident="LC__REPORT__VIEW__CMDB_CHANGES__PERIOD"}]</td>
			<td class="value">
				[{isys type="f_popup" p_bEditMode="1" name="C__IMPORT_TYPES__TIMEPERIOD__START" p_strClass="input-mini" p_strPopupType="calendar" p_bTime="1"}] -
				[{isys type="f_popup" p_bEditMode="1" p_bInfoIconSpacer="0"  name="C__IMPORT_TYPES__TIMEPERIOD__END" p_strPopupType="calendar" p_strClass="input-mini" p_bTime="1"}]
			</td>
		</tr>
		<tr>
			<td></td>
