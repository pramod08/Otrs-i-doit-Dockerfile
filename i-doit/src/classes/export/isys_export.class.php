...
abstract class isys_export implements isys_export_iface
{
    ...
    public function __construct($p_export_type, isys_component_database &$p_database = null)
    {
        ...
        if (!($p_export_type instanceof isys_export_type)) throw new isys_exception_general(
            "Export type is not an instance of isys_export_type or " . "any of its subclasses. Check your instantiation of isys_export."
        );
