...
class isys_component_dao_rt extends isys_component_dao
{
    ...
    public function insert_customfield_value($p_objTypeID)
    {
        ...
        $l_update = "INSERT INTO CustomFieldValues SET " . "CustomField   = " . $this->convert_sql_id($l_cfID) . ", " . "Creator       = " . $this->convert_sql_id(
                $l_userID
    ...
    {
        $l_query = "SELECT " . "Tickets.Status, " . "Tickets.Subject, " . "Tickets.Created, " . "Tickets.LastUpdated, " . "Users.Name " . "FROM Tickets " . "INNER JOIN ObjectCustomFieldValues ON ObjectCustomFieldValues.ObjectId = Tickets.id AND ObjectCustomFieldValues.ObjectType = 'RT::Ticket' " . "INNER JOIN Users ON Users.id = Tickets.Creator " . "AND ObjectCustomFieldValues.Content = '" . $p_cfValue . "'";
