...
class isys_connector_ticketing_otrs extends isys_connector_ticketing
{
    ...
    public function create_new_ticket_url($p_object_id)
    {
        $l_ticket_new_url = [
            ...
            'use_queue'    => 1,
            'select_queue' => [
                'AgentTicketEmail' => _L('LC__TTS__OTRS_EMAIL_TICKET'),
                'AgentTicketPhone' => _L('LC__TTS__OTRS_PHONE_TICKET')
    ...
    public function get_tickets_by_cmdb_object($p_object_id)
    {
        $l_ticket_params = [
            'args'     => [
                ...
                new SoapParam($this->m_pass, 'Password'),
                new SoapVar(
                    '<DynamicField_IDoitObjects><Like>*,' . $p_object_id . ',*</Like></DynamicField_IDoitObjects>', XSD_ANYXML
                )
            ],
            'uri'      => 'Core',
            'style'    => 'SOAP_RPC',
