 ...
 * @license   http://www.i-doit.com/license
 */
class isys_workflow_view_list_handler extends isys_workflow_view_list
{
    ...
    {
        return "i-manageIT::list.handler";
    }
    ...
    {
        return new isys_workflow_dao_list_generic(
            $this->get_module_request()
                ->get_database(), null, $this->get_order_field(), $this->get_order_dir()
        );
    }
