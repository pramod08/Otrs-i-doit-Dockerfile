...
class isys_ajax_handler_chassis extends isys_ajax_handler
{
    ...
    public function init()
    {
        ...
        switch ($_GET['func'])
        {
            ...
            case 'assign_slot_position':
                $l_return = $this->assign_slot_position(
                    $_POST['obj_id'],
                    $_POST['chassis_slot_id'],
                    $_POST['x1'],
                    $_POST['x2'],
                    $_POST['y1'],
                    $_POST['y2'],
    ...
    protected function get_assigned_devices($p_slot_id)
    {
        ...
        $l_return = [
            'success' => false,
            'message' => _L('LC__POPUP__BROWSER__RELATION_BROWSER__NO_ASSIGNED_OBJECTS_FOUND'),
            'devices' => []
        ];
    ...
    protected function assign_slot_position($p_obj_id, $p_slot_id, $p_x1, $p_x2, $p_y1, $p_y2, $p_insertion)
    {
        ...
        else
        {
            return [
                'success' => false,
                'message' => _L('LC__CMDB__CATS__CHASSIS_SLOTS__ALREADY_ASSIGNED')
            ];
        } // if
    } // function
